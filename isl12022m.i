# 1 "drivers/rtc/isl12022m/isl12022m.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/rtc/isl12022m/isl12022m.c"
# 42 "drivers/rtc/isl12022m/isl12022m.c"
# 1 "drivers/rtc/isl12022m/isl12022m.h" 1
# 40 "drivers/rtc/isl12022m/isl12022m.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 41 "drivers/rtc/isl12022m/isl12022m.h" 2
# 1 "./core/i2c/i2c.h" 1
# 97 "./core/i2c/i2c.h"
...
# 42 "drivers/rtc/isl12022m/isl12022m.h" 2
# 66 "drivers/rtc/isl12022m/isl12022m.h"
enum
{
...
typedef enum
{
  ISL12022M_ERROR_OK = 0,
  ISL12022M_ERROR_I2C_INIT,
  ISL12022M_ERROR_I2C_BUSY,
  ISL12022M_ERROR_I2C_BUFFEROVERFLOW,
...
# 43 "drivers/rtc/isl12022m/isl12022m.c" 2
...
# 44 "drivers/rtc/isl12022m/isl12022m.c" 2

extern volatile uint8_t I2CMasterBuffer[64];
extern volatile uint8_t I2CSlaveBuffer[64];
extern volatile uint32_t I2CReadLength, I2CWriteLength;

static _Bool _isl12022mInitialised = 0;
...
isl12022mError_t isl12022mInit(void)
{
  ...
  if (i2cInit(0x01) == 0)
  {
    return ISL12022M_ERROR_I2C_INIT;
  }


  error = isl12022mReadBuffer((0xDE), ISL12022M_REG_CSR_INT, buffer, sizeof(buffer));
  if (!error)
  {
    if (!(buffer[0] & (1<<6)))
    {

      error = isl12022mWrite8((0xDE), ISL12022M_REG_CSR_INT, buffer[0] | (1<<6));
    }
    _isl12022mInitialised = 1;
  }

  return error;
}
# 190 "drivers/rtc/isl12022m/isl12022m.c"
isl12022mError_t isl12022mGetTime(isl12022mTime_t *time)
{
  isl12022mError_t error = ISL12022M_ERROR_OK;
  uint8_t buffer[9];
  ...
  error = isl12022mReadBuffer((0xDE),
...
# 260 "drivers/rtc/isl12022m/isl12022m.c"
isl12022mError_t isl12022mSetTime(uint8_t dayofweek, uint8_t year, uint8_t month, uint8_t day, uint8_t hour, uint8_t minute, uint8_t second)
{
  isl12022mError_t error = ISL12022M_ERROR_OK;
  ...
  error = isl12022mWrite8((0xDE), ISL12022M_REG_RTC_SC, isl12022mDecToBCD(second));
  if (error) return error;
  error = isl12022mWrite8((0xDE), ISL12022M_REG_RTC_MN, isl12022mDecToBCD(minute));
  if (error) return error;

  error = isl12022mWrite8((0xDE), ISL12022M_REG_RTC_HR, hour & 0x3F) | (1<<7);
  if (error) return error;
  error = isl12022mWrite8((0xDE), ISL12022M_REG_RTC_DT, day & 0x3F);
  if (error) return error;
  error = isl12022mWrite8((0xDE), ISL12022M_REG_RTC_MO, month & 0x1F);
  if (error) return error;
  error = isl12022mWrite8((0xDE), ISL12022M_REG_RTC_YR, year);
  if (error) return error;
  error = isl12022mWrite8((0xDE), ISL12022M_REG_RTC_DW, dayofweek & 0x07);
  if (error) return error;

  return error;
}
# 307 "drivers/rtc/isl12022m/isl12022m.c"
isl12022mError_t isl12022mGetTemp(uint8_t *celsius)
{
  isl12022mError_t error = ISL12022M_ERROR_OK;
  uint8_t buffer[2];
  ...
  error = isl12022mReadBuffer((0xDE), ISL12022M_REG_CSR_BETA, buffer, 1);
  if (!error)
  {
    if (!(buffer[0] & (1<<7)))
    {

      error = isl12022mWrite8((0xDE), ISL12022M_REG_CSR_BETA, buffer[0] | (1<<7));
      if (error)
        return error;
    }
  }
  ...
  error = isl12022mReadBuffer((0xDE), ISL12022M_REG_TEMP_TKOL, buffer, 2);
  if (error)
    return error;
