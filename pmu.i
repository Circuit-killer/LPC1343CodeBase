...
void WAKEUP_IRQHandler(void)
{
  ...
  (*((REG32 *) (0x40048208))) = ((unsigned int) 0xFFFFFFFF);


  (*((REG32 *) (0xE000ED10))) &= ~((unsigned int) 0x00000004);


  (*((REG32 *) (0x40014004))) = ((unsigned int) 0x00000000);



  regVal = (*((REG32 *) (0x4004820C)));
  if (regVal != 0)
  {
    (*((REG32 *) (0x40048208))) = regVal;
  }


  timer32Init(0, ((((72000000)/(*((REG32 *) (0x40048078)))) / 10000)));
  timer32Enable(0);
...
static void pmuWDTClockInit (void)
{
  ...
  (*((REG32 *) (0x40048238))) &= ~(((unsigned int) 0x00000040));



  (*((REG32 *) (0x40048024))) = ((unsigned int) 0x00000020) |
                   ((unsigned int) 0x0000001F);


  (*((REG32 *) (0x40048070))) = ((unsigned int) 0x00000002);
  (*((REG32 *) (0x40048074))) = ((unsigned int) 0x00000001);
  (*((REG32 *) (0x40048074))) = ((unsigned int) 0x00000000);
  (*((REG32 *) (0x40048074))) = ((unsigned int) 0x00000001);


  while (!((*((REG32 *) (0x40048074))) & ((unsigned int) 0x00000001)));
}
...
void pmuSleep()
{
  (*((REG32 *) (0x40048234))) = (*((REG32 *) (0x40048238)));
  __asm volatile ("WFI");
  return;
}
# 219 "core/pmu/pmu.c"
void pmuDeepSleep(uint32_t sleepCtrl, uint32_t wakeupSeconds)
{
  ...
  if (wakeupSeconds > 0)
  {
    ...
    (*((REG32 *) (0x40048230))) &= ~(((unsigned int) 0x00000040));


    (*((REG32 *) (0x40014004))) = ((unsigned int) 0x00000000);


    gpioSetPullup(&(*((REG32 *) (0x40044010))), gpioPullupMode_Inactive);


    (*((REG32 *) (0x40048080))) |= (((unsigned int) 0x00000200));


    (*((REG32 *) (0x40044010))) &= ~((unsigned int) 0x00000007);
    (*((REG32 *) (0x40044010))) |= ((unsigned int) 0x00000002);


    (*((REG32 *) (0x40014018))) = 7812 * wakeupSeconds;


    (*((REG32 *) (0x40014014))) |= (((unsigned int) 0x00000001) | ((unsigned int) 0x00000002));


    (*((REG32 *) (0x4001403C))) &= ~(0xFF<<4);
    (*((REG32 *) (0x4001403C))) |= ((unsigned int) 0x00000200);



    NVIC_EnableIRQ(WAKEUP1_IRQn);
# 301 "core/pmu/pmu.c"
    (*((REG32 *) (0x40048200))) |= ((unsigned int) 0x00000002);


    (*((REG32 *) (0x40048208))) = ((unsigned int) 0xFFFFFFFF);


    (*((REG32 *) (0x40048204))) |= ((unsigned int) 0x00000002);


    pmuWDTClockInit();


    (*((REG32 *) (0x40014004))) = ((unsigned int) 0x00000001);
  }
...
void pmuPowerDown( void )
{
  ...
  if ( ((*((REG32 *) (0x40038000))) & ((0x1<<8) | (((unsigned int) 0x00000800)))) != 0x0 )
  {


    regVal = (*((REG32 *) (0x40038000)));
    regVal |= ((0x1<<8) |
               (((unsigned int) 0x00000000)) |
               (((unsigned int) 0x00000800)));
    (*((REG32 *) (0x40038000))) = regVal;

    if ( ((*((REG32 *) (0x40038004))) != 0x12345678)||((*((REG32 *) (0x40038008))) != 0x87654321)
       ||((*((REG32 *) (0x4003800C))) != 0x56781234)||((*((REG32 *) (0x40038010))) != 0x43218765) )
    {
      while (1);
    }
  }
  else
  {
    ...
    (*((REG32 *) (0x40038004))) = 0x12345678;
    (*((REG32 *) (0x40038008))) = 0x87654321;
    (*((REG32 *) (0x4003800C))) = 0x56781234;
    (*((REG32 *) (0x40038010))) = 0x43218765;
    (*((REG32 *) (0xE000ED10))) |= ((unsigned int) 0x00000004);
    (*((REG32 *) (0x40038000))) = ((unsigned int) 0x00000002);
    __asm volatile ("WFI");
  }
  return;
}
