# 1 "drivers/adc/ads1015/ads1015.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/adc/ads1015/ads1015.c"
# 45 "drivers/adc/ads1015/ads1015.c"
# 1 "drivers/adc/ads1015/ads1015.h" 1
# 40 "drivers/adc/ads1015/ads1015.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 41 "drivers/adc/ads1015/ads1015.h" 2
# 1 "./core/i2c/i2c.h" 1
# 97 "./core/i2c/i2c.h"
...
# 42 "drivers/adc/ads1015/ads1015.h" 2
# 118 "drivers/adc/ads1015/ads1015.h"
typedef enum
{
  ADS1015_ERROR_OK = 0,
  ADS1015_ERROR_I2CINIT,
  ADS1015_ERROR_I2CBUSY,
  ADS1015_ERROR_INVALIDCHANNEL,
  ADS1015_ERROR_LAST
}
ads1015Error_t;
...
# 46 "drivers/adc/ads1015/ads1015.c" 2
...
# 47 "drivers/adc/ads1015/ads1015.c" 2

extern volatile uint8_t I2CMasterBuffer[64];
extern volatile uint8_t I2CSlaveBuffer[64];
extern volatile uint32_t I2CReadLength, I2CWriteLength;

static _Bool _ads1015Initialised = 0;
...
ads1015Error_t ads1015Init(void)
{
  ...
  if (i2cInit(0x01) == 0)
  {
    return ADS1015_ERROR_I2CINIT;
  }

  _ads1015Initialised = 1;
  return error;
}
...
ads1015Error_t ads1015ReadADC_SingleEnded(uint8_t channel, uint16_t *value)
{
  ...
  error = ads1015WriteRegister((0x01), config);
...
# 208 "drivers/adc/ads1015/ads1015.c"
ads1015Error_t ads1015ReadADC_Differential_0_1(int16_t *value)
{
  ads1015Error_t error = ADS1015_ERROR_OK;
...
# 259 "drivers/adc/ads1015/ads1015.c"
ads1015Error_t ads1015ReadADC_Differential_2_3(int16_t *value)
{
  ads1015Error_t error = ADS1015_ERROR_OK;
...
# 328 "drivers/adc/ads1015/ads1015.c"
ads1015Error_t ads1015StartComparator_SingleEnded(uint8_t channel, int16_t threshold)
{
  uint16_t value;
  ...
  error = ads1015WriteRegister((0x03), threshold << 4);
  if (error) return error;
...
# 382 "drivers/adc/ads1015/ads1015.c"
ads1015Error_t ads1015GetLastConversionResults(int16_t *value)
{
  ads1015Error_t error = ADS1015_ERROR_OK;
