...
static void wdtClockSetup (void)
{
  ...
  (*((REG32 *) (0x400480D0))) = ((unsigned int) 0x00000002);
  (*((REG32 *) (0x400480D4))) = ((unsigned int) 0x00000001);
  (*((REG32 *) (0x400480D4))) = ((unsigned int) 0x00000000);
  (*((REG32 *) (0x400480D4))) = ((unsigned int) 0x00000001);


  while (!((*((REG32 *) (0x400480D4))) & ((unsigned int) 0x00000001)));


  (*((REG32 *) (0x400480D8))) = ((unsigned int) 0x00000001);
...
void wdtInit (_Bool reset)
{
  ...
  (*((REG32 *) (0x40048080))) |= ((unsigned int) 0x00008000);
  ...
  (*((REG32 *) (0x40004004))) = (0x003FFFFF);


  (*((REG32 *) (0x40004000))) = (0x00000001) |
...
void wdtFeed (void)
{
  ...
  __disable_irq();
  (*((REG32 *) (0x40004008))) = (0x000000AA);
  (*((REG32 *) (0x40004008))) = (0x00000055);
  __enable_irq();
}
