# 1 "drivers/displays/bitmap/st7565/st7565.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/displays/bitmap/st7565/st7565.c"
# 43 "drivers/displays/bitmap/st7565/st7565.c"
...
# 44 "drivers/displays/bitmap/st7565/st7565.c" 2

# 1 "drivers/displays/bitmap/st7565/st7565.h" 1
# 39 "drivers/displays/bitmap/st7565/st7565.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 40 "drivers/displays/bitmap/st7565/st7565.h" 2
...
# 42 "drivers/displays/bitmap/st7565/st7565.h" 2
# 92 "drivers/displays/bitmap/st7565/st7565.h"
...
void st7565Backlight(_Bool state);
...
# 46 "drivers/displays/bitmap/st7565/st7565.c" 2
...
# 48 "drivers/displays/bitmap/st7565/st7565.c" 2
...
# 49 "drivers/displays/bitmap/st7565/st7565.c" 2
...
# 71 "drivers/displays/bitmap/st7565/st7565.c"
void writeBuffer(uint8_t *buffer)
{
  ...
  for(p = 0; p < 8; p++)
  {
    do { gpioSetValue( (2), (1), 0 ); sendByte( 0xB0 | pagemap[p] ); } while (0);;
    do { gpioSetValue( (2), (1), 0 ); sendByte( 0x00 | (0x0 & 0xf) ); } while (0);;
    do { gpioSetValue( (2), (1), 0 ); sendByte( 0x10 | ((0x0 >> 4) & 0xf) ); } while (0);;
    do { gpioSetValue( (2), (1), 0 ); sendByte( 0xE0 ); } while (0);;
    do { gpioSetValue( (2), (1), 1 ); sendByte( 0xff ); } while (0);;

    for(c = 0; c < 128; c++)
    {
      do { gpioSetValue( (2), (1), 1 ); sendByte( buffer[(128*p)+c] ); } while (0);;
    }
  }
}
# 99 "drivers/displays/bitmap/st7565/st7565.c"
void sendByte(uint8_t byte)
{
  int8_t i;
...
void st7565Init(void)
{
  ...
  gpioSetValue((2), (3), 0);
  gpioSetValue((2), (2), 0);
  do { systickDelay( 500 / (1) / (1) ); } while(0);;
  gpioSetValue((2), (2), 1);


  do { gpioSetValue( (2), (1), 0 ); sendByte( 0xA3 ); } while (0);;
  do { gpioSetValue( (2), (1), 0 ); sendByte( 0xA0 ); } while (0);;
  do { gpioSetValue( (2), (1), 0 ); sendByte( 0xC0 ); } while (0);;
  do { gpioSetValue( (2), (1), 0 ); sendByte( 0x40 ); } while (0);;
  do { gpioSetValue( (2), (1), 0 ); sendByte( 0x28 | 0x04 ); } while (0);;
  do { systickDelay( 50 / (1) / (1) ); } while(0);;
  do { gpioSetValue( (2), (1), 0 ); sendByte( 0x28 | 0x06 ); } while (0);;
  do { systickDelay( 50 / (1) / (1) ); } while(0);;
  do { gpioSetValue( (2), (1), 0 ); sendByte( 0x28 | 0x07 ); } while (0);;
  do { systickDelay( 10 / (1) / (1) ); } while(0);;
  do { gpioSetValue( (2), (1), 0 ); sendByte( 0x20 | 0x6 ); } while (0);;


  do { gpioSetValue( (2), (1), 0 ); sendByte( 0xAF ); } while (0);;
  do { gpioSetValue( (2), (1), 0 ); sendByte( 0xA4 ); } while (0);;
...
void st7565SetBrightness(uint8_t val)
{
  do { gpioSetValue( (2), (1), 0 ); sendByte( 0x81 ); } while (0);;
  do { gpioSetValue( (2), (1), 0 ); sendByte( 0 | (val & 0x3f) ); } while (0);;
}
...
# 283 "drivers/displays/bitmap/st7565/st7565.c"
void st7565DrawPixel(uint8_t x, uint8_t y)
{
  if ((x >= 128) || (y >= 64))
    return;
...
# 302 "drivers/displays/bitmap/st7565/st7565.c"
void st7565ClearPixel(uint8_t x, uint8_t y)
{
  if ((x >= 128) || (y >= 64))
    return;
...
# 323 "drivers/displays/bitmap/st7565/st7565.c"
uint8_t st7565GetPixel(uint8_t x, uint8_t y)
{
  if ((x >= 128) || (y >= 64)) return 0;
  return _st7565buffer[x+ (y/8)*128] & (1 << (7-(y%8)));
}
# 366 "drivers/displays/bitmap/st7565/st7565.c"
void st7565DrawString(uint16_t x, uint16_t y, char* text, struct FONT_DEF font)
{
  uint8_t l;
...
# 414 "drivers/displays/bitmap/st7565/st7565.c"
