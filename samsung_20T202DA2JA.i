# 1 "drivers/displays/character/samsung_20T202DA2JA/samsung_20T202DA2JA.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/displays/character/samsung_20T202DA2JA/samsung_20T202DA2JA.c"
# 47 "drivers/displays/character/samsung_20T202DA2JA/samsung_20T202DA2JA.c"
...
# 48 "drivers/displays/character/samsung_20T202DA2JA/samsung_20T202DA2JA.c" 2

# 1 "drivers/displays/character/samsung_20T202DA2JA/samsung_20T202DA2JA.h" 1
# 40 "drivers/displays/character/samsung_20T202DA2JA/samsung_20T202DA2JA.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 41 "drivers/displays/character/samsung_20T202DA2JA/samsung_20T202DA2JA.h" 2
# 92 "drivers/displays/character/samsung_20T202DA2JA/samsung_20T202DA2JA.h"
...
# 50 "drivers/displays/character/samsung_20T202DA2JA/samsung_20T202DA2JA.c" 2
...
# 52 "drivers/displays/character/samsung_20T202DA2JA/samsung_20T202DA2JA.c" 2
...
# 53 "drivers/displays/character/samsung_20T202DA2JA/samsung_20T202DA2JA.c" 2
...
void samsungvfd_begin(uint8_t cols, uint8_t lines, uint8_t brightness)
{
  ...
  if (lines > 1)
    samsungvfd_displayfunction = 0x08;
  else
    samsungvfd_displayfunction = 0x00;
  ...
  samsungvfd_displaymode = 0x02 | 0x00;

  samsungvfd_command(0x04 | samsungvfd_displaymode);

  samsungvfd_command(0x80);


  samsungvfd_displaycontrol = 0x04;
  samsungvfdDisplay();

  samsungvfdClear();
  samsungvfdHome();
}
# 146 "drivers/displays/character/samsung_20T202DA2JA/samsung_20T202DA2JA.c"
void samsungvfdInit(uint8_t brightness)
{
...
void samsungvfdSetBrightness(uint8_t brightness)
{
  ...
  if (brightness <= 0x03)
  {
    samsungvfd_displayfunction &= ~0x03;
    samsungvfd_displayfunction |= brightness;

    samsungvfd_command(0x30 | samsungvfd_displayfunction);
  }
}
...
{
  samsungvfd_displaycontrol &= ~0x04;
  samsungvfd_command(0x08 | samsungvfd_displaycontrol);
}
...
void samsungvfdNoCursor(void)
{
  samsungvfd_displaycontrol &= ~0x02;
  samsungvfd_command(0x08 | samsungvfd_displaycontrol);
}
...
void samsungvfdNoBlink(void)
{
  samsungvfd_displaycontrol &= ~0x01;
  samsungvfd_command(0x08 | samsungvfd_displaycontrol);
}
...
void samsungvfdScrollDisplayLeft(void)
{
  samsungvfd_command(0x10 | 0x08 | 0x00);
}
...
void samsungvfdScrollDisplayRight(void)
{
  samsungvfd_command(0x10 | 0x08 | 0x04);
}
...
void samsungvfdSetCursor(uint8_t row, uint8_t col)
{
  ...
  {
    row = samsungvfd_numlines-1;
  }

  samsungvfd_command(0x80 | (col + row_offsets[row]));
}
