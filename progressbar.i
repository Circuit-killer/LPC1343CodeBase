# 1 "drivers/displays/tft/controls/progressbar.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/displays/tft/controls/progressbar.c"
# 38 "drivers/displays/tft/controls/progressbar.c"
...
# 39 "drivers/displays/tft/controls/progressbar.c" 2

# 1 "drivers/displays/tft/controls/progressbar.h" 1
# 39 "drivers/displays/tft/controls/progressbar.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 40 "drivers/displays/tft/controls/progressbar.h" 2
...
# 41 "drivers/displays/tft/controls/progressbar.h" 2
...
# 41 "drivers/displays/tft/controls/progressbar.c" 2
# 71 "drivers/displays/tft/controls/progressbar.c"
void progressbarRender(uint16_t x, uint16_t y, uint16_t width, uint16_t height, uint8_t progress, uint16_t color, theme_t theme)
{
  ...
  if (progress)
  {
    ...
    brighter = colorsAlphaBlend((uint16_t)(0xFFFF), color, 50);
    darker = colorsAlphaBlend((uint16_t)(0x0000), color, 35);
