# 1 "drivers/sensors/mpl115a2/mpl115a2.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/sensors/mpl115a2/mpl115a2.c"
# 44 "drivers/sensors/mpl115a2/mpl115a2.c"
# 1 "drivers/sensors/mpl115a2/mpl115a2.h" 1
# 40 "drivers/sensors/mpl115a2/mpl115a2.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 41 "drivers/sensors/mpl115a2/mpl115a2.h" 2
# 1 "./core/i2c/i2c.h" 1
# 97 "./core/i2c/i2c.h"
...
# 42 "drivers/sensors/mpl115a2/mpl115a2.h" 2
...
{
  MPL115A2_ERROR_OK = 0,
  MPL115A2_ERROR_I2CINIT,
  MPL115A2_ERROR_I2CBUSY,
  MPL115A2_ERROR_LAST
}
mpl115a2Error_t;
...
# 45 "drivers/sensors/mpl115a2/mpl115a2.c" 2
...
# 46 "drivers/sensors/mpl115a2/mpl115a2.c" 2
...
static _Bool _mpl115a2Initialised = 0;
...
mpl115a2Error_t mpl115a2Init(void)
{
  ...
  if (i2cInit(0x01) == 0)
  {
    return MPL115A2_ERROR_I2CINIT;
  }


  mpl115a2ReadCoefficients();

  _mpl115a2Initialised = 1;
  return error;
}
