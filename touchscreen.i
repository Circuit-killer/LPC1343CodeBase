# 1 "drivers/displays/tft/touchscreen.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/displays/tft/touchscreen.c"
# 38 "drivers/displays/tft/touchscreen.c"
# 1 "drivers/displays/tft/touchscreen.h" 1
# 39 "drivers/displays/tft/touchscreen.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 40 "drivers/displays/tft/touchscreen.h" 2
...
# 39 "drivers/displays/tft/touchscreen.c" 2
...
void adcInit (void);
# 41 "drivers/displays/tft/touchscreen.c" 2
...
# 42 "drivers/displays/tft/touchscreen.c" 2
...
# 43 "drivers/displays/tft/touchscreen.c" 2
...
# 44 "drivers/displays/tft/touchscreen.c" 2
...
# 45 "drivers/displays/tft/touchscreen.c" 2
# 1 "./drivers/displays/tft/drawing.h" 1
# 40 "./drivers/displays/tft/drawing.h"
# 1 "./drivers/displays/tft/lcd.h" 1
# 41 "./drivers/displays/tft/drawing.h" 2

# 1 "./drivers/displays/tft/theme.h" 1
# 48 "./drivers/displays/tft/theme.h"
# 1 "./drivers/displays/tft/fonts/dejavusans9.h" 1



# 1 "./drivers/displays/tft/fonts/../fonts.h" 1
# 46 "./drivers/displays/tft/fonts/../fonts.h"
typedef struct
{
...
# 5 "./drivers/displays/tft/fonts/dejavusans9.h" 2
...
# 49 "./drivers/displays/tft/theme.h" 2
# 78 "./drivers/displays/tft/theme.h"
typedef struct theme_s
{
  uint16_t colorBackground;
  uint16_t colorBorder;
  uint16_t colorBorderDarker;
  uint16_t colorText;
  uint16_t colorTextAlt;
  uint16_t colorFill;
  uint16_t colorFillAlt;
} theme_t;
# 96 "./drivers/displays/tft/theme.h"
theme_t themeGetDefault(void);
# 43 "./drivers/displays/tft/drawing.h" 2




# 1 "./drivers/displays/tft/fonts.h" 1
# 48 "./drivers/displays/tft/drawing.h" 2
...
typedef enum
{
  ...
  DRAW_CORNERS_ALL = 0x0F,
  DRAW_CORNERS_TOP = 0x03,
  DRAW_CORNERS_BOTTOM = 0x0C,
  DRAW_CORNERS_LEFT = 0x05,
  DRAW_CORNERS_RIGHT = 0x0A
} drawCorners_t;
...
# 46 "drivers/displays/tft/touchscreen.c" 2
# 1 "./drivers/displays/tft/controls/labelcentered.h" 1
# 42 "./drivers/displays/tft/controls/labelcentered.h"
void labelcenteredRender(uint16_t x, uint16_t y, uint16_t bgColor, uint16_t fontColor, char *text, theme_t theme);
# 47 "drivers/displays/tft/touchscreen.c" 2





static _Bool _tsInitialised = 0;
static uint8_t _tsThreshhold = (50);
tsPoint_t _tsLCDPoints[3];
tsPoint_t _tsTSPoints[3];
tsMatrix_t _tsMatrix;
# 69 "drivers/displays/tft/touchscreen.c"
void tsReadZ(uint32_t* z1, uint32_t* z2)
{
  ...
  do {(*((REG32 *) (0x4004407C))) &= ~(((unsigned int) 0x00000007) | ((unsigned int) 0x00000080)); (*((REG32 *) (0x4004407C))) |= ((unsigned int) 0x00000001);} while (0);
  do {(*((REG32 *) (0x40044074))) &= ~(((unsigned int) 0x00000007) | ((unsigned int) 0x00000080)); (*((REG32 *) (0x40044074))) |= ((unsigned int) 0x00000001);} while (0);
  do {(*((REG32 *) (0x40044080))) &= ~(((unsigned int) 0x00000007) | ((unsigned int) 0x00000080)); (*((REG32 *) (0x40044080))) |= ((unsigned int) 0x00000001);} while (0);
  ...
  do {(*((REG32 *) (0x40044078))) &= ~(((unsigned int) 0x00000007) | ((unsigned int) 0x00000080)); (*((REG32 *) (0x40044078))) |= ((unsigned int) 0x00000002);} while (0);
  *z1 = adcRead((1));
  ...
  do {(*((REG32 *) (0x40044078))) &= ~(((unsigned int) 0x00000007) | ((unsigned int) 0x00000080)); (*((REG32 *) (0x40044078))) |= ((unsigned int) 0x00000001);} while (0);
  gpioSetDir ((1), (2), 0);

  do {(*((REG32 *) (0x40044080))) &= ~(((unsigned int) 0x00000007) | ((unsigned int) 0x00000080)); (*((REG32 *) (0x40044080))) |= ((unsigned int) 0x00000002);} while (0);
  *z2 = adcRead((3));
}
...
uint32_t tsReadX(void)
{
  ...
  do {(*((REG32 *) (0x40044074))) &= ~(((unsigned int) 0x00000007) | ((unsigned int) 0x00000080)); (*((REG32 *) (0x40044074))) |= ((unsigned int) 0x00000002);} while (0);
...
uint32_t tsReadY(void)
{
  ...
  do {(*((REG32 *) (0x4004407C))) &= ~(((unsigned int) 0x00000007) | ((unsigned int) 0x00000080)); (*((REG32 *) (0x4004407C))) |= ((unsigned int) 0x00000002);} while (0);
...
{
  labelcenteredRender(lcdGetWidth()/2, y, (uint16_t)(0xFFFF), color, text, themeGetDefault());
}
...
{
  drawFill((uint16_t)(0xFFFF));
  tsCalibCenterText("Touch the center of", 50, (uint16_t)(0x3186));
  tsCalibCenterText("the red circle using", 65, (uint16_t)(0x3186));
  tsCalibCenterText("a pen or stylus", 80, (uint16_t)(0x3186));
  drawCircle(x, y, radius, (uint16_t)(0xF800));
  drawCircle(x, y, radius + 2, (uint16_t)(0x8410));
...
# 226 "drivers/displays/tft/touchscreen.c"
int setCalibrationMatrix( tsPoint_t * displayPtr, tsPoint_t * screenPtr, tsMatrix_t * matrixPtr)
{
  ...
  else
  {
    ...
    eepromWriteS32((uint16_t)(0x0031), matrixPtr->An);
    eepromWriteS32((uint16_t)(0x0035), matrixPtr->Bn);
    eepromWriteS32((uint16_t)(0x0039), matrixPtr->Cn);
    eepromWriteS32((uint16_t)(0x003D), matrixPtr->Dn);
    eepromWriteS32((uint16_t)(0x0041), matrixPtr->En);
    eepromWriteS32((uint16_t)(0x0045), matrixPtr->Fn);
    eepromWriteS32((uint16_t)(0x0049), matrixPtr->Divider);
    eepromWriteU8((uint16_t)(0x0030), 1);
  }

  return( retValue ) ;
}
# 285 "drivers/displays/tft/touchscreen.c"
...
# 334 "drivers/displays/tft/touchscreen.c"
void tsInit(void)
{
  ...
  if (eepromReadU8((uint16_t)(0x0030)) == 1)
  {

    _tsMatrix.An = eepromReadS32((uint16_t)(0x0031));
    _tsMatrix.Bn = eepromReadS32((uint16_t)(0x0035));
    _tsMatrix.Cn = eepromReadS32((uint16_t)(0x0039));
    _tsMatrix.Dn = eepromReadS32((uint16_t)(0x003D));
    _tsMatrix.En = eepromReadS32((uint16_t)(0x0041));
    _tsMatrix.Fn = eepromReadS32((uint16_t)(0x0045));
    _tsMatrix.Divider = eepromReadS32((uint16_t)(0x0049));
  }
  else
  {
...
# 373 "drivers/displays/tft/touchscreen.c"
tsTouchError_t tsRead(tsTouchData_t* data, uint8_t calibrating)
{
...
# 431 "drivers/displays/tft/touchscreen.c"
void tsCalibrate(void)
{
  tsTouchData_t data;
...
# 520 "drivers/displays/tft/touchscreen.c"
tsTouchError_t tsWaitForEvent(tsTouchData_t* data, uint32_t timeoutMS)
{
  if (!_tsInitialised) tsInit();
...
int tsSetThreshhold(uint8_t value)
{
  ...
  eepromWriteU8((uint16_t)(0x004D), value);
...
uint8_t tsGetThreshhold(void)
{
  ...
  uint8_t thold = eepromReadU8((uint16_t)(0x004D));
  if (thold != 0xFF)
  {
