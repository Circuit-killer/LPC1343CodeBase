# 1 "drivers/displays/tft/controls/hsbchart.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/displays/tft/controls/hsbchart.c"
# 38 "drivers/displays/tft/controls/hsbchart.c"
...
# 39 "drivers/displays/tft/controls/hsbchart.c" 2

# 1 "drivers/displays/tft/controls/hsbchart.h" 1
# 39 "drivers/displays/tft/controls/hsbchart.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 40 "drivers/displays/tft/controls/hsbchart.h" 2
...
# 41 "drivers/displays/tft/controls/hsbchart.h" 2

void hsbchartRender(uint16_t x, uint16_t y, uint16_t size, uint16_t baseColor, theme_t theme);
# 41 "drivers/displays/tft/controls/hsbchart.c" 2
# 56 "drivers/displays/tft/controls/hsbchart.c"
void hsbchartRender(uint16_t x, uint16_t y, uint16_t size, uint16_t baseColor, theme_t theme)
{
  uint32_t delta;
  uint16_t colorS;
  ...
  if (size > 2)
  {
    ...
    for (b = 0; b<size-1; b++)
    {
      ...
      colorS = colorsAlphaBlend((uint16_t)(0xFFFF), baseColor, 100 - (b*delta) / 100);
      for (s = 0; s<size-1; s++)
      {

        color = colorsAlphaBlend(colorS, (uint16_t)(0x0000), 100 - (s*delta) / 100);
