# 1 "core/usbcdc/cdcuser.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "core/usbcdc/cdcuser.c"
# 19 "core/usbcdc/cdcuser.c"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 23 "core/usbcdc/cdcuser.c" 2
# 1 "core/usbcdc/usbcfg.h" 1
# 24 "core/usbcdc/cdcuser.c" 2
...
# 27 "core/usbcdc/cdcuser.c" 2
# 1 "core/usbcdc/cdc_buf.h" 1
# 13 "core/usbcdc/cdc_buf.h"
...
# 150 "core/usbcdc/cdcuser.c"
uint32_t CDC_SendEncapsulatedCommand (void) {

  return (1);
}
# 162 "core/usbcdc/cdcuser.c"
uint32_t CDC_GetEncapsulatedResponse (void) {


  return (1);
}
# 175 "core/usbcdc/cdcuser.c"
uint32_t CDC_SetCommFeature (unsigned short wFeatureSelector) {


  return (1);
}
# 188 "core/usbcdc/cdcuser.c"
uint32_t CDC_GetCommFeature (unsigned short wFeatureSelector) {


  return (1);
}
# 201 "core/usbcdc/cdcuser.c"
uint32_t CDC_ClearCommFeature (unsigned short wFeatureSelector) {


  return (1);
}
# 214 "core/usbcdc/cdcuser.c"
...
# 260 "core/usbcdc/cdcuser.c"
uint32_t CDC_SetControlLineState (unsigned short wControlSignalBitmap) {


  return (1);
}
# 275 "core/usbcdc/cdcuser.c"
...
void CDC_BulkOut(void) {
  ...
  numBytesRead = USB_ReadEP(0x03, &BulkBufOut[0]);
