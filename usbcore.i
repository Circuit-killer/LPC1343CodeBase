# 1 "core/usbcdc/usbcore.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "core/usbcdc/usbcore.c"
# 24 "core/usbcdc/usbcore.c"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 25 "core/usbcdc/usbcore.c" 2

# 1 "core/usbcdc/usb.h" 1
# 23 "core/usbcdc/usb.h"
typedef union {
  uint16_t W;
  struct {
    uint8_t L;
...
# 27 "core/usbcdc/usbcore.c" 2
# 1 "core/usbcdc/usbcfg.h" 1
# 28 "core/usbcdc/usbcore.c" 2
# 1 "core/usbcdc/usbhw.h" 1
# 38 "core/usbcdc/usbhw.h"
...
# 29 "core/usbcdc/usbcore.c" 2
# 1 "core/usbcdc/usbcore.h" 1
# 25 "core/usbcdc/usbcore.h"
...
extern uint8_t USB_AltSetting[1];
...
# 30 "core/usbcdc/usbcore.c" 2
# 1 "core/usbcdc/usbdesc.h" 1
# 30 "core/usbcdc/usbdesc.h"
extern const uint8_t USB_DeviceDescriptor[];
extern const uint8_t USB_ConfigDescriptor[];
extern const uint8_t USB_StringDescriptor[];
# 31 "core/usbcdc/usbcore.c" 2
# 1 "core/usbcdc/usbuser.h" 1
# 24 "core/usbcdc/usbuser.h"
...
# 42 "core/usbcdc/usbuser.h"
extern void (* const USB_P_EP[5])(uint32_t event);
...
# 32 "core/usbcdc/usbcore.c" 2
# 52 "core/usbcdc/usbcore.c"
# 1 "core/usbcdc/cdc.h" 1
# 175 "core/usbcdc/cdc.h"
...
# 53 "core/usbcdc/usbcore.c" 2
# 1 "core/usbcdc/cdcuser.h" 1
# 23 "core/usbcdc/cdcuser.h"
...
# 54 "core/usbcdc/usbcore.c" 2
# 62 "core/usbcdc/usbcore.c"
...
# 102 "core/usbcdc/usbcore.c"
void USB_SetupStage (void) {
  USB_ReadEP(0x00, (uint8_t *)&SetupPacket);
}
# 113 "core/usbcdc/usbcore.c"
...
# 148 "core/usbcdc/usbcore.c"
void USB_StatusInStage (void) {
  USB_WriteEP(0x80, ((void *)0), 0);
}
# 159 "core/usbcdc/usbcore.c"
void USB_StatusOutStage (void) {
  USB_ReadEP(0x00, EP0Buf);
}
# 170 "core/usbcdc/usbcore.c"
