# 1 "drivers/sensors/tcs3414/tcs3414.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/sensors/tcs3414/tcs3414.c"
# 49 "drivers/sensors/tcs3414/tcs3414.c"
# 1 "drivers/sensors/tcs3414/tcs3414.h" 1
# 40 "drivers/sensors/tcs3414/tcs3414.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 41 "drivers/sensors/tcs3414/tcs3414.h" 2
# 1 "./core/i2c/i2c.h" 1
# 97 "./core/i2c/i2c.h"
...
# 42 "drivers/sensors/tcs3414/tcs3414.h" 2
# 81 "drivers/sensors/tcs3414/tcs3414.h"
typedef enum
{
  tcs3414Gain_1 = 0x00,
  tcs3414Gain_4 = 0x10,
...
tcs3414Gain_t;
# 97 "drivers/sensors/tcs3414/tcs3414.h"
typedef enum
{
...
{
  TCS3414_ERROR_OK = 0,
  TCS3414_ERROR_I2CINIT,
  TCS3414_ERROR_I2CBUSY,
  TCS3414_ERROR_LAST
}
tcs3414Error_e;
...
# 50 "drivers/sensors/tcs3414/tcs3414.c" 2
...
# 51 "drivers/sensors/tcs3414/tcs3414.c" 2

extern volatile uint8_t I2CMasterBuffer[64];
extern volatile uint8_t I2CSlaveBuffer[64];
extern volatile uint32_t I2CReadLength, I2CWriteLength;

static _Bool _tcs3414Initialised = 0;
...
tcs3414Error_e tcs3414Init(void)
{
  ...
  if (i2cInit(0x01) == 0)
  {
    return TCS3414_ERROR_I2CINIT;
  }

  _tcs3414Initialised = 1;
...
tcs3414Error_e tcs3414SetSensitivity(tcs3414Gain_t gain, tcs3414Prescalar_t prescalar)
{
  ...
  error = tcs3414Write8((0x80) | (0x00), (0x03));
  if (error) return error;


  error = tcs3414Write8((0x80) | (0x07), gain | prescalar);
  if (error) return error;


  error = tcs3414Write8((0x80) | (0x00), (0x00));
  if (error) return error;
...
tcs3414Error_e tcs3414GetRGBL(uint16_t *red, uint16_t *green, uint16_t *blue, uint16_t *clear)
{
  ...
  error = tcs3414Read16((0x80) | (0x20) | (0x12), red);
  if (error) return error;


  error = tcs3414Read16((0x80) | (0x20) | (0x10), green);
  if (error) return error;


  error = tcs3414Read16((0x80) | (0x20) | (0x14), blue);
  if (error) return error;


  error = tcs3414Read16((0x80) | (0x20) | (0x16), clear);
  if (error) return error;
...
# 226 "drivers/sensors/tcs3414/tcs3414.c"
uint32_t tcs3414CalculateCCT (uint16_t red, uint16_t green, uint16_t blue)
{
    volatile float R;
    volatile float G;
