...
# 39 "core/libc/stdio.c" 2
# 1 "/Users/mm/arm-cs-tools/lib/gcc/arm-none-eabi/4.6.3/include/stdarg.h" 1 3 4
# 102 "/Users/mm/arm-cs-tools/lib/gcc/arm-none-eabi/4.6.3/include/stdarg.h" 3 4
typedef __gnuc_va_list va_list;
# 40 "core/libc/stdio.c" 2
...
# 43 "core/libc/stdio.c" 2
# 61 "core/libc/stdio.c"
signed int append_char(char *pStr, char c)
{
    *pStr = c;
    return 1;
}
# 74 "core/libc/stdio.c"
    ...
    while (*pFormat != 0 && size < length) {
        ...
        if (*pFormat != '%') {
            ...
            *pStr++ = '%';
            ...
            switch (*pFormat) {
            case 'd':
            case 'i': num = PutSignedInt(pStr, fill, width, __builtin_va_arg(ap,signed int)); break;
            case 'u': num = PutUnsignedInt(pStr, fill, width, __builtin_va_arg(ap,unsigned int)); break;
            case 'x': num = PutHexa(pStr, fill, width, 0, __builtin_va_arg(ap,unsigned int)); break;
            case 'X': num = PutHexa(pStr, fill, width, 1, __builtin_va_arg(ap,unsigned int)); break;
            case 's': num = PutString(pStr, fill, width, __builtin_va_arg(ap,char *)); break;
            case 'c': num = append_char(pStr, __builtin_va_arg(ap,unsigned int)); break;
            default:
                return (-1);
            }
...
# 388 "core/libc/stdio.c"
signed int snprintf(char *pString, size_t length, const char *pFormat, ...)
{
    va_list ap;
    signed int rc;

    __builtin_va_start(ap,pFormat);
    rc = vsnprintf(pString, length, pFormat, ap);
    __builtin_va_end(ap);

    return rc;
}
# 408 "core/libc/stdio.c"
signed int vsprintf(char *pString, const char *pFormat, va_list ap)
{
    return vsnprintf(pString, (255), pFormat, ap);
}
...
signed int vprintf(const char *pFormat, va_list ap)
{
  ...
  if (vsprintf(pStr, pFormat, ap) >= (255)) {
