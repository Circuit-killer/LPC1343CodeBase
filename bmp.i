# 1 "drivers/displays/tft/bmp.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/displays/tft/bmp.c"
# 42 "drivers/displays/tft/bmp.c"
...
# 43 "drivers/displays/tft/bmp.c" 2

# 1 "drivers/displays/tft/bmp.h" 1
# 39 "drivers/displays/tft/bmp.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 40 "drivers/displays/tft/bmp.h" 2
# 70 "drivers/displays/tft/bmp.h"
typedef struct
{
  uint16_t type;
  uint32_t size;
...
# 106 "drivers/displays/tft/bmp.h"
typedef enum
{
...
typedef enum
{
  ...
  BMP_ERROR_NOTABITMAP = 10,
  BMP_ERROR_INVALIDBITDEPTH = 11,
  BMP_ERROR_COMPRESSEDDATA = 12,
  BMP_ERROR_INVALIDDIMENSIONS = 13,
  BMP_ERROR_PREMATUREEOF = 14
} bmp_error_t;

bmp_error_t bmpDrawBitmap(uint16_t x, uint16_t y, const char* filename);
# 45 "drivers/displays/tft/bmp.c" 2
...
# 47 "drivers/displays/tft/bmp.c" 2
# 1 "./drivers/displays/tft/lcd.h" 1
# 48 "drivers/displays/tft/bmp.c" 2
