...
# 1 "<command-line>"
# 1 "drivers/rsa/rsa.c"
# 28 "drivers/rsa/rsa.c"
# 1 "drivers/rsa/rsa.h" 1
# 19 "drivers/rsa/rsa.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 20 "drivers/rsa/rsa.h" 2
# 28 "drivers/rsa/rsa.h"
...
void rsaTest()
{
  ...
  printf("Encrypting with RSA %s", "\r\n");
# 76 "drivers/rsa/rsa.c"
  publicKey.e = 17;
  publicKey.n = 209;
  privateKey.d = 53;
  privateKey.n = 209;
  ...
  printf("d=%u, e=%u, n=%u %s", (unsigned int)privateKey.d, (unsigned int)publicKey.e, (unsigned int)publicKey.n, "\r\n");
  ...
  for (i = 0; i < 128; i++)
  {
    ...
    if (rsaOrig == rsaDecrypted)
    {
      ...
      printf("In=%5u, Encrypted=%5u, Out=%5u (OK) %s", (unsigned int)rsaOrig, (unsigned int)rsaEncrypted, (unsigned int)rsaDecrypted, "\r\n");
    ...
    else
    {
      ...
      printf("In=%5u, Encrypted=%5u, Out=%5u (ERROR) %s", (unsigned int)rsaOrig, (unsigned int)rsaEncrypted, (unsigned int)rsaDecrypted, "\r\n");
