# 1 "drivers/storage/eeprom/eeprom.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/storage/eeprom/eeprom.c"
# 36 "drivers/storage/eeprom/eeprom.c"
...
# 37 "drivers/storage/eeprom/eeprom.c" 2
...
# 39 "drivers/storage/eeprom/eeprom.c" 2
...
# 40 "drivers/storage/eeprom/eeprom.c" 2


# 1 "./drivers/storage/eeprom/mcp24aa/mcp24aa.h" 1
# 49 "./drivers/storage/eeprom/mcp24aa/mcp24aa.h"
typedef enum
{
  MCP24AA_ERROR_OK = 0,
  MCP24AA_ERROR_I2CINIT,
  MCP24AA_ERROR_I2CBUSY,
  MCP24AA_ERROR_ADDRERR,
  MCP24AA_ERROR_BUFFEROVERFLOW,
  MCP24AA_ERROR_LAST
}
mcp24aaError_e;
...
# 43 "drivers/storage/eeprom/eeprom.c" 2

static uint8_t buf[32];
# 56 "drivers/storage/eeprom/eeprom.c"
_Bool eepromCheckAddress(uint16_t addr)
{

  return addr <= 0xFFF ? 0 : 1;
}
# 72 "drivers/storage/eeprom/eeprom.c"
uint8_t eepromReadU8(uint16_t addr)
{
...
# 93 "drivers/storage/eeprom/eeprom.c"
int8_t eepromReadS8(uint16_t addr)
{
  int8_t results;
...
# 117 "drivers/storage/eeprom/eeprom.c"
uint16_t eepromReadU16(uint16_t addr)
{
  uint16_t results;
...
# 142 "drivers/storage/eeprom/eeprom.c"
int16_t eepromReadS16(uint16_t addr)
{
  int16_t results;
...
# 166 "drivers/storage/eeprom/eeprom.c"
uint32_t eepromReadU32(uint16_t addr)
{
  uint32_t results;
...
# 190 "drivers/storage/eeprom/eeprom.c"
int32_t eepromReadS32(uint16_t addr)
{
  int32_t results;
...
# 214 "drivers/storage/eeprom/eeprom.c"
uint64_t eepromReadU64(uint16_t addr)
{
  uint64_t results;
...
# 238 "drivers/storage/eeprom/eeprom.c"
int64_t eepromReadS64(uint16_t addr)
{
  int64_t results;
...
# 264 "drivers/storage/eeprom/eeprom.c"
void eepromReadBuffer(uint16_t addr, uint8_t *buffer, uint32_t bufferLength)
{
...
# 284 "drivers/storage/eeprom/eeprom.c"
void eepromWriteU8(uint16_t addr, uint8_t value)
{
  mcp24aaError_e error = MCP24AA_ERROR_OK;
...
# 301 "drivers/storage/eeprom/eeprom.c"
void eepromWriteS8(uint16_t addr, int8_t value)
{
  mcp24aaError_e error = MCP24AA_ERROR_OK;
  error = mcp24aaWriteBuffer(addr, (uint8_t *)&value, sizeof(value));
...
# 318 "drivers/storage/eeprom/eeprom.c"
void eepromWriteU16(uint16_t addr, uint16_t value)
{
  mcp24aaError_e error = MCP24AA_ERROR_OK;
  error = mcp24aaWriteBuffer(addr, (uint8_t *)&value, sizeof(value));
...
# 335 "drivers/storage/eeprom/eeprom.c"
void eepromWriteS16(uint16_t addr, int16_t value)
{
  mcp24aaError_e error = MCP24AA_ERROR_OK;
  error = mcp24aaWriteBuffer(addr, (uint8_t *)&value, sizeof(value));
...
# 352 "drivers/storage/eeprom/eeprom.c"
void eepromWriteU32(uint16_t addr, uint32_t value)
{
  mcp24aaError_e error = MCP24AA_ERROR_OK;
  error = mcp24aaWriteBuffer(addr, (uint8_t *)&value, sizeof(value));
...
# 369 "drivers/storage/eeprom/eeprom.c"
void eepromWriteS32(uint16_t addr, int32_t value)
{
  mcp24aaError_e error = MCP24AA_ERROR_OK;
  error = mcp24aaWriteBuffer(addr, (uint8_t *)&value, sizeof(value));
...
# 386 "drivers/storage/eeprom/eeprom.c"
void eepromWriteU64(uint16_t addr, uint64_t value)
{
  mcp24aaError_e error = MCP24AA_ERROR_OK;
  error = mcp24aaWriteBuffer(addr, (uint8_t *)&value, sizeof(value));
...
# 403 "drivers/storage/eeprom/eeprom.c"
void eepromWriteS64(uint16_t addr, int64_t value)
{
  mcp24aaError_e error = MCP24AA_ERROR_OK;
  error = mcp24aaWriteBuffer(addr, (uint8_t *)&value, sizeof(value));
