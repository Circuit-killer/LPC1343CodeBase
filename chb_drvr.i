# 1 "drivers/rf/chibi/chb_drvr.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/rf/chibi/chb_drvr.c"
# 34 "drivers/rf/chibi/chb_drvr.c"
...
# 35 "drivers/rf/chibi/chb_drvr.c" 2
# 1 "drivers/rf/chibi/chb.h" 1
# 37 "drivers/rf/chibi/chb.h"
# 1 "drivers/rf/chibi/types.h" 1
# 41 "drivers/rf/chibi/types.h"
# 1 "/Users/mm/arm-cs-tools/lib/gcc/arm-none-eabi/4.6.3/include/stdbool.h" 1 3 4
# 42 "drivers/rf/chibi/types.h" 2
...
typedef int16_t S16;
typedef int32_t S32;
# 38 "drivers/rf/chibi/chb.h" 2
# 58 "drivers/rf/chibi/chb.h"
enum
{
    CHB_SUCCESS = 0,
...
typedef struct
{
    U16 src_addr;
    U8 seq;
    volatile _Bool data_rcv;
    volatile _Bool tx_end;
...
# 36 "drivers/rf/chibi/chb_drvr.c" 2
# 1 "drivers/rf/chibi/chb_drvr.h" 1
# 38 "drivers/rf/chibi/chb_drvr.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 39 "drivers/rf/chibi/chb_drvr.h" 2
...
# 40 "drivers/rf/chibi/chb_drvr.h" 2
# 94 "drivers/rf/chibi/chb_drvr.h"
enum
{
    CCA_ED = 1,
    CCA_CARRIER_SENSE = 2,
    CCA_CARRIER_SENSE_WITH_ED = 3
};
...
enum
{
  CHB_PWR_EU1_2DBM = 0x63,
  CHB_PWR_EU1_1DBM = 0x64,
  CHB_PWR_EU1_0DBM = 0x65,
  CHB_PWR_EU2_5DBM = 0xE7,
  CHB_PWR_EU2_4DBM = 0xE8,
  CHB_PWR_EU2_3DBM = 0xE9,
  CHB_PWR_EU2_2DBM = 0xEA,
  CHB_PWR_EU2_1DBM = 0xCB,
  CHB_PWR_EU2_0DBM = 0xAB,
  CHB_PWR_NA_10DBM = 0xC0,
...
# 334 "drivers/rf/chibi/chb_drvr.h"
void chb_drvr_init();
...
# 371 "drivers/rf/chibi/chb_drvr.h"
void chb_ISR_Handler (void);
# 37 "drivers/rf/chibi/chb_drvr.c" 2
# 1 "drivers/rf/chibi/chb_buf.h" 1
# 39 "drivers/rf/chibi/chb_buf.h"
void chb_buf_init();
void chb_buf_write(U8 data);
U8 chb_buf_read();
U32 chb_buf_get_len();
# 38 "drivers/rf/chibi/chb_drvr.c" 2
# 1 "drivers/rf/chibi/chb_spi.h" 1
# 59 "drivers/rf/chibi/chb_spi.h"
void chb_spi_init();
U8 chb_xfer_byte(U8 data);
# 39 "drivers/rf/chibi/chb_drvr.c" 2
# 1 "drivers/rf/chibi/chb_eeprom.h" 1
# 47 "drivers/rf/chibi/chb_eeprom.h"
void chb_eeprom_write(U16 addr, U8 *buf, U16 size);
void chb_eeprom_read(U16 addr, U8 *buf, U16 size);
# 40 "drivers/rf/chibi/chb_drvr.c" 2
...
# 42 "drivers/rf/chibi/chb_drvr.c" 2
# 1 "./core/timer16/timer16.h" 1
# 49 "./core/timer16/timer16.h"
...
# 43 "drivers/rf/chibi/chb_drvr.c" 2
...
static void chb_delay_us(U16 usec)
{
  ...
  uint32_t maxus = 0xFFFF / ((72000000) / 1000000);
...
void chb_reset()
{
    do {gpioSetValue(1, 9, 1); } while (0);
    do {gpioSetValue(1, 10, 0); } while (0);


    chb_delay_us(TIME_P_ON_TO_CLKM_AVAIL);


    do {gpioSetValue(1, 9, 0); } while (0);
    ...
    while (1)
    {
        ...
        if ((chb_reg_read(VERSION_NUM) == 0x01) && (chb_reg_read(PART_NUM) == 0x07))
        {
            break;
        }
    }
...
U8 chb_reg_read(U8 addr)
{
    ...
    __disable_irq();
    do {gpioSetValue((0), (2), 0);} while (0);


    val = chb_xfer_byte(addr);
    val = chb_xfer_byte(val);

    do {gpioSetValue((0), (2), 1);} while (0);
    __enable_irq();
...
# 403 "drivers/rf/chibi/chb_drvr.c"
void chb_set_mode(U8 mode)
{
    switch (mode)
    {
    case OQPSK_868MHZ:
        ...
        chb_reg_read_mod_write(RF_CTRL_0, CHB_OQPSK_TX_OFFSET, 0x3);
        break;
    case OQPSK_915MHZ:
        ...
        break;
    case OQPSK_780MHZ:
        chb_reg_read_mod_write(TRX_CTRL_2, 0x1c, 0x3f);
        chb_reg_read_mod_write(RF_CTRL_0, CHB_OQPSK_TX_OFFSET, 0x3);
        break;
    case BPSK40_915MHZ:
...
{
    U8 state;
# 486 "drivers/rf/chibi/chb_drvr.c"
...
# 516 "drivers/rf/chibi/chb_drvr.c"
U8 chb_set_state(U8 state)
{
    U8 curr_state, delay;


    if (gpioGetValue(1, 10))
    {
...
void chb_set_ieee_addr(U8 *addr)
{
    chb_eeprom_write((uint16_t)(0x0000), addr, 8);
...
void chb_get_ieee_addr(U8 *addr)
{
    chb_eeprom_read((uint16_t)(0x0000), addr, 8);
}
...
void chb_set_short_addr(U16 addr)
{
    ...
    chb_eeprom_write((uint16_t)(0x0009), addr_ptr, 2);
...
U16 chb_get_short_addr()
{
    ...
    chb_eeprom_read((uint16_t)(0x0009), (uint8_t*)&addr, 2);
    return addr;
}
# 652 "drivers/rf/chibi/chb_drvr.c"
U8 chb_tx(U8 *hdr, U8 *data, U8 len)
{
    ...
    chb_frame_write(hdr, 9 + 1, data, len);
...
# 714 "drivers/rf/chibi/chb_drvr.c"
    ...
    chb_reg_write16(PAN_ID_0, (0x1234));
...
# 759 "drivers/rf/chibi/chb_drvr.c"
    gpioSetDir (1, 8, 0);


    gpioSetPullup (&(*((REG32 *) (0x40044014))), gpioPullupMode_Inactive);
...
void chb_drvr_init()
{
    ...
    gpioSetPullup (&(*((REG32 *) (0x4004406C))), gpioPullupMode_Inactive);
    gpioSetPullup (&(*((REG32 *) (0x40044038))), gpioPullupMode_Inactive);
...
void chb_sleep(U8 enb)
{
  if (enb)
  {
    ...
    do {gpioSetValue(1, 10, 1); } while (0);
  }
  else
  {
