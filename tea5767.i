# 1 "drivers/audio/tea5767/tea5767.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/audio/tea5767/tea5767.c"
# 38 "drivers/audio/tea5767/tea5767.c"
# 1 "drivers/audio/tea5767/tea5767.h" 1
# 40 "drivers/audio/tea5767/tea5767.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 41 "drivers/audio/tea5767/tea5767.h" 2
# 143 "drivers/audio/tea5767/tea5767.h"
uint32_t tea5767Init( void );
void tea5767SetFrequency( uint32_t );
uint32_t tea5767GetFrequency( void );
void tea5767Scan( uint8_t );
void tea5767Mute( _Bool );
# 39 "drivers/audio/tea5767/tea5767.c" 2
# 1 "./core/i2c/i2c.h" 1
# 97 "./core/i2c/i2c.h"
...
# 40 "drivers/audio/tea5767/tea5767.c" 2
...
# 41 "drivers/audio/tea5767/tea5767.c" 2

extern volatile uint8_t I2CMasterBuffer[64];
extern volatile uint8_t I2CSlaveBuffer[64];

static _Bool _tea5767Initialised = 0;
...
# 112 "drivers/audio/tea5767/tea5767.c"
_Bool tea5767CheckCrystal(void)
{
# 140 "drivers/audio/tea5767/tea5767.c"
  uint8_t ifValue = 0;
...
# 196 "drivers/audio/tea5767/tea5767.c"
void tea5767SetFrequency( uint32_t frequency )
{
  ...
  buffer[0] = (pllValue >> 8) & 0x3F;
  buffer[1] = (pllValue & 0xFF);
  buffer[2] = (1<<4);
  buffer[3] = (1<<4);
  buffer[4] = 0;
...
# 254 "drivers/audio/tea5767/tea5767.c"
void tea5767Scan( uint8_t scanDirection )
{
  ...
  if (scanDirection) wbuffer[2] |= (1<<7);
