...
volatile uint32_t I2CMasterState = 0x000;
volatile uint32_t I2CSlaveState = 0x000;
...
void I2C_IRQHandler(void)
{
 ...
 case 0x08:
  ...
  WrIndex = 0;
  (*((REG32 *) (0x40000008))) = I2CMasterBuffer[WrIndex++];
  (*((REG32 *) (0x40000018))) = (0x00000008 | 0x00000020);
  I2CMasterState = 0x001;
  break;
 ...
 case 0x20:
  ...
  (*((REG32 *) (0x40000000))) = 0x00000010;
  (*((REG32 *) (0x40000018))) = 0x00000008;
  I2CMasterState = 0x103;
  break;
 ...
 case 0x28:
  ...
  else
  {
   if ( I2CReadLength != 0 )
   {
    ...
    (*((REG32 *) (0x40000000))) = 0x00000020;
   }
   else
   {
    I2CMasterState = 0x101;
    (*((REG32 *) (0x40000000))) = 0x00000010;
   }
  }
  (*((REG32 *) (0x40000018))) = 0x00000008;
 ...
 case 0x40:
  ...
  if ( I2CReadLength == 1 )
  {
   ...
   (*((REG32 *) (0x40000018))) = 0x00000004;
  }
  else
  {

   (*((REG32 *) (0x40000000))) = 0x00000004;
  }
  (*((REG32 *) (0x40000018))) = 0x00000008;
  break;
 ...
 case 0x50:
  ...
  I2CSlaveBuffer[RdIndex++] = (*((REG32 *) (0x40000008)));
...
static uint32_t I2CStart( void )
{
  ...
  while((I2CMasterState != 0x001) && (timeout < 0x00FFFFFF))
  {
    timeout++;
  }

  return (timeout < 0x00FFFFFF);
}
# 325 "core/i2c/i2c.c"
static uint32_t I2CStop( void )
{
  ...
  while(((*((REG32 *) (0x40000000))) & 0x00000010) && (timeout < 0x00FFFFFF))
  {
    timeout++;
  }
  return (timeout >= 0x00FFFFFF);
...
uint32_t i2cInit( uint32_t I2cMode )
{
  ...
  (*((REG32 *) (0x40048004))) |= (0x1<<1);


  (*((REG32 *) (0x40048080))) |= (((unsigned int) 0x00000020));


  (*((REG32 *) (0x40044030))) &= ~(((unsigned int) 0x00000007) | ((unsigned int) 0x00000300));
  (*((REG32 *) (0x40044030))) |= (((unsigned int) 0x00000001));


  (*((REG32 *) (0x40044034))) &= ~(((unsigned int) 0x00000007) | ((unsigned int) 0x00000300));
  (*((REG32 *) (0x40044034))) |= ((unsigned int) 0x00000001);


  (*((REG32 *) (0x40000018))) = ((unsigned int) 0x00000004) |
                  ((unsigned int) 0x00000008) |
                  ((unsigned int) 0x00000020) |
                  ((unsigned int) 0x00000040);
# 380 "core/i2c/i2c.c"
  (*((REG32 *) (0x40000014))) = (72000000) / 800000;
  (*((REG32 *) (0x40000010))) = (72000000) / 800000;


  if ( _I2cMode == 0x02 )
  {
    (*((REG32 *) (0x4000000C))) = 0xA0;
    I2CSlaveState = 0;
  }
  ...
  if ( _I2cMode == 0x01 )
  {
    (*((REG32 *) (0x40000000))) = ((unsigned int) 0x00000040);
  }
