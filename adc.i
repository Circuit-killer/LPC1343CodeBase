...
static _Bool _adcInitialised = 0;
...
uint32_t adcReadSingle (uint8_t channelNum)
{
  ...
  (*((REG32 *) (0x4001C000))) &= ~(0x000000FF);


  (*((REG32 *) (0x4001C000))) |= (0x01000000) | (1 << channelNum);
  ...
  while ( 1 )
  {
    ...
    {
      case 0:
        regVal = (*((REG32 *)(((unsigned int) 0x4001C010))));
        break;
      case 1:
        regVal = (*((REG32 *)(((unsigned int) 0x4001C014))));
        break;
      case 2:
        regVal = (*((REG32 *)(((unsigned int) 0x4001C018))));
        break;
      case 3:
        regVal = (*((REG32 *)(((unsigned int) 0x4001C01C))));
        break;
      case 4:
        regVal = (*((REG32 *)(((unsigned int) 0x4001C020))));
        break;
      case 5:
        regVal = (*((REG32 *)(((unsigned int) 0x4001C024))));
        break;
      case 6:
        regVal = (*((REG32 *)(((unsigned int) 0x4001C028))));
        break;
      case 7:
        regVal = (*((REG32 *)(((unsigned int) 0x4001C02C))));
        break;
      default:
        regVal = (*((REG32 *)(((unsigned int) 0x4001C010))));
        break;
...
void adcInit (void)
{
  ...
  (*((REG32 *) (0x40048238))) &= ~(((unsigned int) 0x00000010));


  (*((REG32 *) (0x40048080))) |= (((unsigned int) 0x00002000));





  (*((REG32 *) (0x40044074))) &= ~(((unsigned int) 0x00000080) |
                              ((unsigned int) 0x00000007) |
                              ((unsigned int) 0x00000018));
  (*((REG32 *) (0x40044074))) |= (((unsigned int) 0x00000002) &
                              ((unsigned int) 0x00000000));


  (*((REG32 *) (0x40044078))) &= ~(((unsigned int) 0x00000080) |
                              ((unsigned int) 0x00000007) |
                              ((unsigned int) 0x00000018));
  (*((REG32 *) (0x40044078))) |= (((unsigned int) 0x00000002) &
                              ((unsigned int) 0x00000000));


  (*((REG32 *) (0x4004407C))) &= ~(((unsigned int) 0x00000080) |
                              ((unsigned int) 0x00000007) |
                              ((unsigned int) 0x00000018));
  (*((REG32 *) (0x4004407C))) |= (((unsigned int) 0x00000002) &
                              ((unsigned int) 0x00000000));


  (*((REG32 *) (0x40044080))) &= ~(((unsigned int) 0x00000080) |
                               ((unsigned int) 0x00000007) |
                               ((unsigned int) 0x00000018));
  (*((REG32 *) (0x40044080))) |= (((unsigned int) 0x00000002) &
                               ((unsigned int) 0x00000000));



  (*((REG32 *) (0x4001C000))) = ((0x00000001) |
              ((((72000000) / (*((REG32 *) (0x40048078)))) / 1000000 - 1 ) << 8) |
              (0x00000000) |
              (0x00000000) |
              (0x00000000) |
              (0x00000000));
