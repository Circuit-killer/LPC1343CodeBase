# 1 "core/systick/systick.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "core/systick/systick.c"
# 64 "core/systick/systick.c"
# 1 "core/systick/systick.h" 1
# 42 "core/systick/systick.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 94 "core/systick/systick.c"
}
# 106 "core/systick/systick.c"
static uint32_t systickConfig(uint32_t ticks)
{
  ...
  (*((REG32 *) (0xE000E014))) = (ticks & (0x00FFFFFF)) - 1;


  (*((REG32 *) (0xE000E018))) = 0;


  (*((REG32 *) (0xE000E010))) = (0x00000004) |
                   (0x00000002) |
                   (0x00000001);

  return (0);
}
# 149 "core/systick/systick.c"
void systickInit (uint32_t delayMs)
{
  systickConfig (((72000000) / 1000) * delayMs);
}
# 168 "core/systick/systick.c"
void systickDelay (uint32_t delayTicks)
{
  uint32_t curTicks;
...
# 197 "core/systick/systick.c"
uint32_t systickGetTicks(void)
{
  return systickTicks;
}
# 209 "core/systick/systick.c"
uint32_t systickGetRollovers(void)
{
...
uint32_t systickGetSecondsActive(void)
{
  ...
  uint32_t secsActive = currentTick / (1000 / (1));
  secsActive += rollovers * (0xFFFFFFFF / (1000 / (1)));
