...
uint32_t pwmPulseWidth = ((72000000) / 1000);
...
void pwmInit(void)
{
  ...
  (*((REG32 *) (0x40044038))) &= ~((unsigned int) 0x00000007);
  (*((REG32 *) (0x40044038))) |= ((unsigned int) 0x00000001);


  (*((REG32 *) (0x40010024))) = pwmPulseWidth;


  (*((REG32 *) (0x40010018))) = (pwmPulseWidth * (100 - pwmDutyCycle)) / 100;


  (*((REG32 *) (0x40010014))) = (((unsigned int) 0x00000400));


  (*((REG32 *) (0x4001003C))) = ((unsigned int) 0x00000030) | ((unsigned int) 0x00000001);


  (*((REG32 *) (0x40010004))) &= ~((unsigned int) 0x00000001);


  (*((REG32 *) (0x40010074))) = ((unsigned int) 0x00000001) | ((unsigned int) 0x00000008);
...
void pwmStart(void)
{
  ...
  (*((REG32 *) (0x40010014))) &= ~(((unsigned int) 0x00000200));
...
int pwmSetDutyCycle(uint32_t percentage)
{
  ...
  (*((REG32 *) (0x40010018))) = (pwmPulseWidth * (100 - (pwmDutyCycle = percentage))) / 100;
...
int pwmSetFrequencyInTicks(uint16_t ticks)
{
  ...
  (*((REG32 *) (0x40010024))) = (pwmPulseWidth = ticks - 1);
...
int pwmSetFrequencyInMicroseconds(uint16_t us)
{
  ...
  uint32_t ticks = ((((72000000)/(*((REG32 *) (0x40048078)))) / 1000000) * us);
  if (ticks > 0xFFFF)
  {
