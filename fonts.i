# 1 "drivers/displays/tft/fonts.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/displays/tft/fonts.c"
# 39 "drivers/displays/tft/fonts.c"
# 1 "drivers/displays/tft/fonts.h" 1
# 39 "drivers/displays/tft/fonts.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 40 "drivers/displays/tft/fonts.h" 2
...
# 40 "drivers/displays/tft/fonts.c" 2
...
# 41 "drivers/displays/tft/fonts.c" 2
# 1 "drivers/displays/tft/drawing.h" 1
# 42 "drivers/displays/tft/drawing.h"
...
# 54 "drivers/displays/tft/drawing.h"
typedef enum
{
...
# 42 "drivers/displays/tft/fonts.c" 2
# 54 "drivers/displays/tft/fonts.c"
...
# 126 "drivers/displays/tft/fonts.c"
void fontsDrawString(uint16_t x, uint16_t y, uint16_t color, const FONT_INFO *fontInfo, char *str)
{
...
# 197 "drivers/displays/tft/fonts.c"
uint16_t fontsGetStringWidth(const FONT_INFO *fontInfo, char *str)
{
  uint16_t width = 0;
  uint32_t currChar;
