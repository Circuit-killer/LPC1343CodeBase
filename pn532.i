...
# 12 "drivers/rf/pn532/pn532.c" 2

static pn532_pcb_t pcb;
# 23 "drivers/rf/pn532/pn532.c"
void pn532PrintHex(const byte_t * pbtData, const size_t szBytes)
{
  size_t szPos;
