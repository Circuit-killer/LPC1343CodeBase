# 1 "drivers/sensors/tsl2561/tsl2561.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/sensors/tsl2561/tsl2561.c"
# 67 "drivers/sensors/tsl2561/tsl2561.c"
# 1 "drivers/sensors/tsl2561/tsl2561.h" 1
# 40 "drivers/sensors/tsl2561/tsl2561.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 41 "drivers/sensors/tsl2561/tsl2561.h" 2
# 1 "./core/i2c/i2c.h" 1
# 97 "./core/i2c/i2c.h"
...
# 42 "drivers/sensors/tsl2561/tsl2561.h" 2
# 115 "drivers/sensors/tsl2561/tsl2561.h"
enum
{
...
# 68 "drivers/sensors/tsl2561/tsl2561.c" 2
...
# 69 "drivers/sensors/tsl2561/tsl2561.c" 2

extern volatile uint8_t I2CMasterBuffer[64];
extern volatile uint8_t I2CSlaveBuffer[64];
extern volatile uint32_t I2CReadLength, I2CWriteLength;

static _Bool _tsl2561Initialised = 0;
...
tsl2561Error_t tsl2561Enable(void)
{
  ...
  return tsl2561Write8((0x80) | TSL2561_REGISTER_CONTROL, (0x03));
}
...
tsl2561Error_t tsl2561Disable(void)
{
  ...
  return tsl2561Write8((0x80) | TSL2561_REGISTER_CONTROL, (0x00));
}
...
tsl2561Error_t tsl2561SetTiming(tsl2561IntegrationTime_t integration, tsl2561Gain_t gain)
{
  ...
  error = tsl2561Write8((0x80) | TSL2561_REGISTER_TIMING, integration | gain);
  if (error) return error;
...
tsl2561Error_t tsl2561GetLuminosity (uint16_t *broadband, uint16_t *ir)
{
  ...
  error = tsl2561Read16((0x80) | (0x20) | TSL2561_REGISTER_CHAN0_LOW, broadband);
  if (error) return error;


  error = tsl2561Read16((0x80) | (0x20) | TSL2561_REGISTER_CHAN1_LOW, ir);
  if (error) return error;
...
uint32_t tsl2561CalculateLux(uint16_t ch0, uint16_t ch1)
{
  ...
  if ((ratio >= 0) && (ratio <= (0x0043)))
    ...
    {b=(0x0000); m=(0x0000);}
# 351 "drivers/sensors/tsl2561/tsl2561.c"
  unsigned long temp;
