# 1 "core/usbcdc/cdc_buf.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "core/usbcdc/cdc_buf.c"
# 51 "core/usbcdc/cdc_buf.c"
# 1 "core/usbcdc/cdc_buf.h" 1
# 10 "core/usbcdc/cdc_buf.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 83 "core/usbcdc/cdc_buf.c"
uint8_t cdcBufferRead()
{
  uint8_t data;

  data = cdcfifo.buf[cdcfifo.rd_ptr];
  cdcfifo.rd_ptr = (cdcfifo.rd_ptr + 1) % (256);
  cdcfifo.len--;
  return data;
}
...
# 129 "core/usbcdc/cdc_buf.c"
void cdcBufferWrite(uint8_t data)
{
  cdcfifo.buf[cdcfifo.wr_ptr] = data;
  cdcfifo.wr_ptr = (cdcfifo.wr_ptr + 1) % (256);
  cdcfifo.len++;
}
