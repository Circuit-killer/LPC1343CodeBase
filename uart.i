...
# 95 "core/uart/uart.c" 2

# 1 "core/uart/uart.h" 1
# 42 "core/uart/uart.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
...
_Bool uartRxBufferReadArray(byte_t* rx, size_t* len);
# 97 "core/uart/uart.c" 2
# 109 "core/uart/uart.c"
...
void UART_IRQHandler(void)
{
  ...
  IIRValue = (*((REG32 *) (0x40008008)));
  IIRValue &= ~(((unsigned int) 0x00000001));
  IIRValue &= ((unsigned int) 0x0000000E);


  if (IIRValue == ((unsigned int) 0x00000006))
  {
    LSRValue = (*((REG32 *) (0x40008014)));

    if (LSRValue & (((unsigned int) 0x00000002) | ((unsigned int) 0x00000004) | ((unsigned int) 0x00000008) | ((unsigned int) 0x00000080) | ((unsigned int) 0x00000010)))
    {


      pcb.status = LSRValue;
      Dummy = (*((REG32 *) (0x40008000)));
      return;
    }

    if (LSRValue & ((unsigned int) 0x00000001))
    {


      uartRxBufferWrite((*((REG32 *) (0x40008000))));
    }
  }


  else if (IIRValue == ((unsigned int) 0x00000004))
  {
  ...
  else if (IIRValue == ((unsigned int) 0x0000000C))
  {
  ...
  else if (IIRValue == ((unsigned int) 0x00000002))
  {

    LSRValue = (*((REG32 *) (0x40008014)));
    if (LSRValue & ((unsigned int) 0x00000020))
    {
...
# 197 "core/uart/uart.c"
uart_pcb_t *uartGetPCB()
{
    return &pcb;
}
# 210 "core/uart/uart.c"
void uartInit(uint32_t baudrate)
{
  uint32_t fDiv;
  uint32_t regVal;
  ...
  (*((REG32 *) (0x400440A4))) &= ~((unsigned int) 0x00000007);
  (*((REG32 *) (0x400440A4))) |= ((unsigned int) 0x00000001);


  (*((REG32 *) (0x400440A8))) &= ~((unsigned int) 0x00000007);
  (*((REG32 *) (0x400440A8))) |= ((unsigned int) 0x00000001);


  (*((REG32 *) (0x40048080))) |= (((unsigned int) 0x00001000));
  (*((REG32 *) (0x40048098))) = ((unsigned int) 0x00000001);


  (*((REG32 *) (0x4000800C))) = (((unsigned int) 0x00000003) |
                ((unsigned int) 0x00000000) |
                ((unsigned int) 0x00000000) |
                ((unsigned int) 0x00000000) |
                ((unsigned int) 0x00000000) |
                ((unsigned int) 0x00000080));


  regVal = (*((REG32 *) (0x40048098)));
  fDiv = ((((72000000) * (*((REG32 *) (0x40048078))))/regVal)/16)/baudrate;

  (*((REG32 *) (0x40008004))) = fDiv / 256;
  (*((REG32 *) (0x40008000))) = fDiv % 256;
  ...
  (*((REG32 *) (0x40008008))) = (((unsigned int) 0x00000001) |
                ((unsigned int) 0x00000002) |
                ((unsigned int) 0x00000004));


  regVal = (*((REG32 *) (0x40008014)));


  while (( (*((REG32 *) (0x40008014))) & (((unsigned int) 0x00000020)|((unsigned int) 0x00000040))) != (((unsigned int) 0x00000020)|((unsigned int) 0x00000040)) );
  while ( (*((REG32 *) (0x40008014))) & ((unsigned int) 0x00000001) )
  {

    regVal = (*((REG32 *) (0x40008000)));
  }
  ...
  (*((REG32 *) (0x40008004))) = ((unsigned int) 0x00000001) | ((unsigned int) 0x00000004);

  return;
}
# 304 "core/uart/uart.c"
void uartSend (uint8_t *bufferPtr, uint32_t length)
{
  while (length != 0)
  {

    while ( !((*((REG32 *) (0x40008014))) & ((unsigned int) 0x00000020)) );
    (*((REG32 *) (0x40008000))) = *bufferPtr;
...
# 337 "core/uart/uart.c"
void uartSendByte (uint8_t byte)
{

  while ( !((*((REG32 *) (0x40008014))) & ((unsigned int) 0x00000020)) );
  (*((REG32 *) (0x40008000))) = byte;
