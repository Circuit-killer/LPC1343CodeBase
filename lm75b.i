# 1 "drivers/sensors/lm75b/lm75b.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/sensors/lm75b/lm75b.c"
# 84 "drivers/sensors/lm75b/lm75b.c"
# 1 "drivers/sensors/lm75b/lm75b.h" 1
# 42 "drivers/sensors/lm75b/lm75b.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 43 "drivers/sensors/lm75b/lm75b.h" 2
# 1 "./core/i2c/i2c.h" 1
# 97 "./core/i2c/i2c.h"
...
# 44 "drivers/sensors/lm75b/lm75b.h" 2
# 55 "drivers/sensors/lm75b/lm75b.h"
typedef enum
{
  LM75B_ERROR_OK = 0,
  LM75B_ERROR_I2CINIT,
...
# 85 "drivers/sensors/lm75b/lm75b.c" 2

extern volatile uint8_t I2CMasterBuffer[64];
extern volatile uint8_t I2CSlaveBuffer[64];
extern volatile uint32_t I2CReadLength, I2CWriteLength;

static _Bool _lm75bInitialised = 0;
...
lm75bError_e lm75bInit(void)
{
  ...
  return lm75bConfigWrite ((0x01));
}
# 181 "drivers/sensors/lm75b/lm75b.c"
lm75bError_e lm75bGetTemperature (int32_t *temp)
{
  if (!_lm75bInitialised) lm75bInit();


  lm75bConfigWrite ((0x00));


  lm75bError_e error = LM75B_ERROR_OK;
  error = lm75bRead16 ((0x00), temp);


  lm75bConfigWrite ((0x01));
...
lm75bError_e lm75bConfigWrite (uint8_t configValue)
{
  ...
  return lm75bWrite8 ((0x01), configValue);
}
