# 1 "drivers/sensors/ina219/ina219.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/sensors/ina219/ina219.c"
# 74 "drivers/sensors/ina219/ina219.c"
# 1 "drivers/sensors/ina219/ina219.h" 1
# 40 "drivers/sensors/ina219/ina219.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 41 "drivers/sensors/ina219/ina219.h" 2
# 1 "./core/i2c/i2c.h" 1
# 97 "./core/i2c/i2c.h"
...
# 42 "drivers/sensors/ina219/ina219.h" 2
# 127 "drivers/sensors/ina219/ina219.h"
...
# 75 "drivers/sensors/ina219/ina219.c" 2
...
# 76 "drivers/sensors/ina219/ina219.c" 2
...
# 208 "drivers/sensors/ina219/ina219.c"
  ...
  uint16_t config = (0x4000) |
                    ...
                    (0x0018) |
                    (0x0007);
  ina219WriteRegister((0x00), config);
}
# 233 "drivers/sensors/ina219/ina219.c"
void ina219SetCalibration_32V_1A(void)
{
# 299 "drivers/sensors/ina219/ina219.c"
  ina219_currentDivider_mA = 25;
  ina219_powerDivider_mW = 1;


  ina219WriteRegister((0x05), 0x2800);
...
# 324 "drivers/sensors/ina219/ina219.c"
void ina219SetCalibration_16V_500mA(void)
{
# 384 "drivers/sensors/ina219/ina219.c"
  ina219_currentDivider_mA = 40;
  ina219_powerDivider_mW = 1;


  ina219WriteRegister((0x05), 0x4000);
...
# 409 "drivers/sensors/ina219/ina219.c"
void ina219SetCalibration_16V_200mA(void)
{
# 465 "drivers/sensors/ina219/ina219.c"
  ina219_currentDivider_mA = 100;
  ina219_powerDivider_mW = 1;


  ina219WriteRegister((0x05), 0xA000);
...
void ina219Init(void)
{
  ...
  ina219WriteRegister((0x00), (0x8000));
