# 1 "drivers/displays/tft/theme.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/displays/tft/theme.c"
# 38 "drivers/displays/tft/theme.c"
...
# 39 "drivers/displays/tft/theme.c" 2

# 1 "drivers/displays/tft/theme.h" 1
# 41 "drivers/displays/tft/theme.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 42 "drivers/displays/tft/theme.h" 2
...
# 44 "drivers/displays/tft/theme.h" 2
...
# 41 "drivers/displays/tft/theme.c" 2
# 67 "drivers/displays/tft/theme.c"
theme_t themeGetDefault(void)
{
  theme_t themeDefault = { .colorBackground = (uint16_t)(0xFFFF),
                           .colorBorder = (uint16_t)(0x8410),
                           .colorBorderDarker = (uint16_t)(0x528A),
                           .colorText = (uint16_t)(0x0000),
                           .colorTextAlt = (uint16_t)(0x3186),
                           .colorFill = (uint16_t)(0xCE59),
                           .colorFillAlt = (uint16_t)(0xE71C) };
