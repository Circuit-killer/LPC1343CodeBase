# 1 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.c"
# 84 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.c"
...
# 85 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.c" 2
...
# 87 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.c" 2
...
# 88 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.c" 2
# 1 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.h" 1
# 11 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.h"
...
pn532_mifare_cmd_t;
# 12 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.h" 2
...
# 89 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.c" 2
...
# 91 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.c" 2
# 123 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.c"
pn532_error_t pn532_mifareultralight_WaitForPassiveTarget (byte_t * pbtCUID, size_t * szCUIDLen)
{
  byte_t abtResponse[(64)];
  pn532_error_t error;
  size_t szLen;
# 136 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.c"
...
# 169 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.c"
  }
  else
  {
# 190 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.c"
    return PN532_ERROR_WRONGCARDTYPE;
  }

  return PN532_ERROR_NONE;
}
# 210 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.c"
pn532_error_t pn532_mifareultralight_ReadPage (uint8_t page, byte_t * pbtBuffer)
{
  pn532_error_t error;
  byte_t abtCommand[4];
...
# 284 "drivers/rf/pn532/helpers/pn532_mifare_ultralight.c"
  return PN532_ERROR_NONE;
}
