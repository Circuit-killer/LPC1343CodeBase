# 1 "project/commands/drawing/cmd_line.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "project/commands/drawing/cmd_line.c"
# 39 "project/commands/drawing/cmd_line.c"
...
# 40 "project/commands/drawing/cmd_line.c" 2
...
# 42 "project/commands/drawing/cmd_line.c" 2
# 1 "./core/cmd/cmd.h" 1
# 44 "./core/cmd/cmd.h"
typedef struct
{
...
void cmdInit();
# 43 "project/commands/drawing/cmd_line.c" 2
# 1 "./project/commands.h" 1
# 42 "./project/commands.h"
int getNumber (char *s, int32_t *result);
# 44 "project/commands/drawing/cmd_line.c" 2
