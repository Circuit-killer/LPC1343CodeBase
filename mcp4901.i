# 1 "drivers/dac/mcp4901/mcp4901.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/dac/mcp4901/mcp4901.c"
# 36 "drivers/dac/mcp4901/mcp4901.c"
# 1 "drivers/dac/mcp4901/mcp4901.h" 1
# 40 "drivers/dac/mcp4901/mcp4901.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 41 "drivers/dac/mcp4901/mcp4901.h" 2
...
# 42 "drivers/dac/mcp4901/mcp4901.h" 2

void mcp4901Init(void);
void mcp4901SetVoltage( uint8_t output);
void mcp4901LDAC(void);
void mcp4901ChangeSettings(_Bool BUFFER, _Bool GAIN, _Bool SHUTDOWN);
# 37 "drivers/dac/mcp4901/mcp4901.c" 2
...
uint16_t settings;
# 64 "drivers/dac/mcp4901/mcp4901.c"
void mcpWriteData(uint8_t data)
{
  ...
  for (i=0; i<8; i++)
  {
    if (data & 0x80)
    {
     do { (*((REG32 *) (0x50023FFC))) &= ~(1<<(8)); (*((REG32 *) (0x50023FFC))) |= (1<<(8)); } while(0);
    }
    else
    {

     do { (*((REG32 *) (0x50023FFC))) &= ~(1<<(8)); } while(0);
    }
    data <<= 1;
    do { (*((REG32 *) (0x50023FFC))) &= ~(1<<(7)); } while(0);
    do { (*((REG32 *) (0x50023FFC))) &= ~(1<<(7)); (*((REG32 *) (0x50023FFC))) |= (1<<(7)); } while(0);
  }
}
...
void mcp4901Init()
{
 settings = (0 << 2 | 1 << 1 | 1) << 12;
 gpioSetDir((2), (0) , gpioDirection_Output);
 gpioSetDir((2), (6) , gpioDirection_Output);
...
# 122 "drivers/dac/mcp4901/mcp4901.c"
 do { (*((REG32 *) (0x50023FFC))) &= ~(1<<(6)); } while(0);
 mcpWriteData16(data);
 do { (*((REG32 *) (0x50023FFC))) &= ~(1<<(6)); (*((REG32 *) (0x50023FFC))) |= (1<<(6)); } while(0);
}
