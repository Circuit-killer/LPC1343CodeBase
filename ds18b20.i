# 1 "drivers/sensors/ds18b20/ds18b20.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/sensors/ds18b20/ds18b20.c"
# 64 "drivers/sensors/ds18b20/ds18b20.c"
# 1 "drivers/sensors/ds18b20/ds18b20.h" 1
# 42 "drivers/sensors/ds18b20/ds18b20.h"
...
# 43 "drivers/sensors/ds18b20/ds18b20.h" 2
...
# 44 "drivers/sensors/ds18b20/ds18b20.h" 2


void ds18b20Init(uint32_t portNum, uint32_t bitPos, volatile uint32_t *ioconReg);
uint32_t ds18b20GetTemperature();
# 65 "drivers/sensors/ds18b20/ds18b20.c" 2
# 81 "drivers/sensors/ds18b20/ds18b20.c"
uint32_t portNum = 0;
uint32_t bitPos = 0;
...
uint32_t ds18b20GetTemperature(){
 ...
 if(reset()) {
        printf("DS18B20 is not responding%s", "\r\n");
        return 0;
    }
 writeByte(0xcc);
 writeByte(0x44);
 ...
 while(!readBit() && timeout > 0) {
    ...
    if(0 == timeout) {
        printf("BS18B20 temperature conversion has timed out%s", "\r\n");
        return 0;
    }
