# 1 "drivers/displays/tft/controls/huechart.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/displays/tft/controls/huechart.c"
# 38 "drivers/displays/tft/controls/huechart.c"
...
# 39 "drivers/displays/tft/controls/huechart.c" 2

# 1 "drivers/displays/tft/controls/huechart.h" 1
# 39 "drivers/displays/tft/controls/huechart.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 40 "drivers/displays/tft/controls/huechart.h" 2
...
# 41 "drivers/displays/tft/controls/huechart.h" 2

void huechartRender(uint16_t x, uint16_t y, uint16_t width, uint16_t height, theme_t theme);
# 41 "drivers/displays/tft/controls/huechart.c" 2
# 57 "drivers/displays/tft/controls/huechart.c"
void huechartRender(uint16_t x, uint16_t y, uint16_t width, uint16_t height, theme_t theme)
{
  ...
  drawGradient(x+1, y+1, x+width-1, y+delta-1, (uint16_t)(0xF800), (uint16_t)(0xF81F));
  drawGradient(x+1, y+delta, x+width-1, y+(delta*2)-1, (uint16_t)(0xF81F), (uint16_t)(0x001F));
  drawGradient(x+1, y+(delta*2), x+width-1, y+(delta*3)-1, (uint16_t)(0x001F), (uint16_t)(0x07FF));
  drawGradient(x+1, y+(delta*3), x+width-1, y+(delta*4)-1, (uint16_t)(0x07FF), (uint16_t)(0x07E0));
  drawGradient(x+1, y+(delta*4), x+width-1, y+(delta*5)-1, (uint16_t)(0x07E0), (uint16_t)(0xFFE0));
  drawGradient(x+1, y+(delta*5), x+width-1, y+height-1, (uint16_t)(0xFFE0), (uint16_t)(0xF800));
}
