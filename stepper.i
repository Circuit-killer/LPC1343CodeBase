# 1 "drivers/motor/stepper/stepper.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/motor/stepper/stepper.c"
# 73 "drivers/motor/stepper/stepper.c"
...
# 74 "drivers/motor/stepper/stepper.c" 2

# 1 "drivers/motor/stepper/stepper.h" 1
# 40 "drivers/motor/stepper/stepper.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 41 "drivers/motor/stepper/stepper.h" 2
# 51 "drivers/motor/stepper/stepper.h"
...
# 76 "drivers/motor/stepper/stepper.c" 2
...
# 77 "drivers/motor/stepper/stepper.c" 2
# 1 "./core/timer32/timer32.h" 1
# 57 "./core/timer32/timer32.h"
...
# 78 "drivers/motor/stepper/stepper.c" 2

static int64_t stepperPosition = 0;
static uint32_t stepperStepNumber = 0;
static uint32_t stepperStepsPerRotation = 0;
static uint32_t stepperStepDelay = 0;
...
# 129 "drivers/motor/stepper/stepper.c"
void stepperInit(uint32_t steps)
{
...
# 158 "drivers/motor/stepper/stepper.c"
int64_t stepperGetPosition()
{
  return stepperPosition;
}
# 172 "drivers/motor/stepper/stepper.c"
uint32_t stepperGetRotation()
{
  return stepperStepNumber;
}
# 184 "drivers/motor/stepper/stepper.c"
void stepperSetHome()
{
  stepperPosition = 0;
}
...
# 206 "drivers/motor/stepper/stepper.c"
void stepperSetZero()
{
  stepperStepNumber = 0;
}
# 218 "drivers/motor/stepper/stepper.c"
void stepperMoveZero()
{
...
# 239 "drivers/motor/stepper/stepper.c"
void stepperSetSpeed(uint32_t rpm)
{
  uint32_t ticksOneRPM = (((72000000)/(*((REG32 *) (0x40048078)))) / stepperStepsPerRotation) * 60;
...
# 262 "drivers/motor/stepper/stepper.c"
void stepperStep(int32_t steps)
{
