# 1 "drivers/displays/tft/drawing.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/displays/tft/drawing.c"
# 39 "drivers/displays/tft/drawing.c"
...
# 40 "drivers/displays/tft/drawing.c" 2

# 1 "drivers/displays/tft/drawing.h" 1
# 39 "drivers/displays/tft/drawing.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 40 "drivers/displays/tft/drawing.h" 2
...
# 42 "drivers/displays/tft/drawing.c" 2
# 54 "drivers/displays/tft/drawing.c"
...
# 126 "drivers/displays/tft/drawing.c"
void drawPixel(uint16_t x, uint16_t y, uint16_t color)
{
...
# 142 "drivers/displays/tft/drawing.c"
void drawFill(uint16_t color)
{
  lcdFillRGB(color);
}
...
# 211 "drivers/displays/tft/drawing.c"
void drawLine ( uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color )
{
  drawLineDotted(x0, y0, x1, y1, 0, 1, color);
}
# 239 "drivers/displays/tft/drawing.c"
...
# 386 "drivers/displays/tft/drawing.c"
void drawCircle (uint16_t xCenter, uint16_t yCenter, uint16_t radius, uint16_t color)
{
...
# 409 "drivers/displays/tft/drawing.c"
void drawCircleFilled (uint16_t xCenter, uint16_t yCenter, uint16_t radius, uint16_t color)
{
  int16_t f = 1 - radius;
  int16_t ddF_x = 1;
...
# 475 "drivers/displays/tft/drawing.c"
void drawCorner (uint16_t xCenter, uint16_t yCenter, uint16_t r, drawCorners_t corner, uint16_t color)
{
  int16_t f = 1 - r;
  int16_t ddF_x = 1;
...
# 534 "drivers/displays/tft/drawing.c"
void drawCornerFilled (uint16_t xCenter, uint16_t yCenter, uint16_t radius, drawCorners_t position, uint16_t color)
{
  int16_t f = 1 - radius;
  int16_t ddF_x = 1;
...
# 613 "drivers/displays/tft/drawing.c"
...
# 670 "drivers/displays/tft/drawing.c"
void drawRectangle ( uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color)
{
  uint16_t x, y;
...
# 712 "drivers/displays/tft/drawing.c"
void drawRectangleFilled ( uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color)
{
  int height;
  uint16_t x, y;
...
# 768 "drivers/displays/tft/drawing.c"
void drawRoundedRectangle ( uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color, uint16_t radius, drawCorners_t corners )
{
  int height;
  uint16_t y;
...
# 873 "drivers/displays/tft/drawing.c"
void drawRoundedRectangleFilled ( uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color, uint16_t radius, drawCorners_t corners )
{
  int height;
  uint16_t y;
...
# 999 "drivers/displays/tft/drawing.c"
void drawGradient ( uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t startColor, uint16_t endColor)
{
  int height;
  uint16_t x, y;
...
# 1069 "drivers/displays/tft/drawing.c"
void drawTriangle ( uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t color)
{
...
# 1109 "drivers/displays/tft/drawing.c"
void drawTriangleFilled ( uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t color)
{
...
# 1195 "drivers/displays/tft/drawing.c"
void drawIcon16(uint16_t x, uint16_t y, uint16_t color, uint16_t icon[])
{
  int i;
  for (i = 0; i<16; i++)
