# 1 "drivers/storage/eeprom/mcp24aa/mcp24aa.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/storage/eeprom/mcp24aa/mcp24aa.c"
# 103 "drivers/storage/eeprom/mcp24aa/mcp24aa.c"
# 1 "drivers/storage/eeprom/mcp24aa/mcp24aa.h" 1
# 42 "drivers/storage/eeprom/mcp24aa/mcp24aa.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 43 "drivers/storage/eeprom/mcp24aa/mcp24aa.h" 2
...
# 104 "drivers/storage/eeprom/mcp24aa/mcp24aa.c" 2
...
# 105 "drivers/storage/eeprom/mcp24aa/mcp24aa.c" 2
# 1 "./core/i2c/i2c.h" 1
# 97 "./core/i2c/i2c.h"
...
# 106 "drivers/storage/eeprom/mcp24aa/mcp24aa.c" 2

extern volatile uint8_t I2CMasterBuffer[64];
extern volatile uint8_t I2CSlaveBuffer[64];
extern volatile uint32_t I2CReadLength, I2CWriteLength;

static _Bool _mcp24aaInitialised = 0;
...
mcp24aaError_e mcp24aaInit()
{
  ...
  _mcp24aaInitialised = 1;

  return MCP24AA_ERROR_OK;
}
# 148 "drivers/storage/eeprom/mcp24aa/mcp24aa.c"
mcp24aaError_e mcp24aaReadBuffer (uint16_t address, uint8_t *buffer, uint32_t bufferLength)
{
  ...
  I2CMasterBuffer[1] = (address >> 8);
  I2CMasterBuffer[2] = (address & 0xFF);



  I2CMasterBuffer[3] = 0xA0 | 0x01;
...
# 212 "drivers/storage/eeprom/mcp24aa/mcp24aa.c"
mcp24aaError_e mcp24aaWriteBuffer (uint16_t address, uint8_t *buffer, uint32_t bufferLength)
{
  if (!_mcp24aaInitialised) mcp24aaInit();
...
# 288 "drivers/storage/eeprom/mcp24aa/mcp24aa.c"
mcp24aaError_e mcp24aaReadByte (uint16_t address, uint8_t *buffer)
{
  if (!_mcp24aaInitialised) mcp24aaInit();
...
# 328 "drivers/storage/eeprom/mcp24aa/mcp24aa.c"
mcp24aaError_e mcp24aaWriteByte (uint16_t address, uint8_t value)
{
  if (!_mcp24aaInitialised) mcp24aaInit();
