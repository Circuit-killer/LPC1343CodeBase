# 1 "core/usbcdc/usbuser.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "core/usbcdc/usbuser.c"
# 18 "core/usbcdc/usbuser.c"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 21 "core/usbcdc/usbuser.c" 2
# 1 "core/usbcdc/usbcfg.h" 1
# 22 "core/usbcdc/usbuser.c" 2
...
# 26 "core/usbcdc/usbuser.c" 2
# 46 "core/usbcdc/usbuser.c"
void USB_Reset_Event (void) {
  USB_ResetCore();
}
# 58 "core/usbcdc/usbuser.c"
void USB_Suspend_Event (void) {
}
# 69 "core/usbcdc/usbuser.c"
void USB_Resume_Event (void) {
}
# 114 "core/usbcdc/usbuser.c"
...
# 148 "core/usbcdc/usbuser.c"
void (* const USB_P_EP[5]) (uint32_t event) = {
  ((0x000B & (1 << (0))) ? USB_EndPoint0 : ((void *)0)),
  ((0x000B & (1 << (1))) ? USB_EndPoint1 : ((void *)0)),
  ((0x000B & (1 << (2))) ? USB_EndPoint2 : ((void *)0)),
  ((0x000B & (1 << (3))) ? USB_EndPoint3 : ((void *)0)),
  ((0x000B & (1 << (4))) ? USB_EndPoint4 : ((void *)0)),
};
# 163 "core/usbcdc/usbuser.c"
...
# 185 "core/usbcdc/usbuser.c"
void USB_EndPoint2 (uint32_t event) {
  event = event;
}
# 196 "core/usbcdc/usbuser.c"
