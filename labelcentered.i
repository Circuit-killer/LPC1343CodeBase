# 1 "drivers/displays/tft/controls/labelcentered.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/displays/tft/controls/labelcentered.c"
# 38 "drivers/displays/tft/controls/labelcentered.c"
...
# 39 "drivers/displays/tft/controls/labelcentered.c" 2

# 1 "drivers/displays/tft/controls/labelcentered.h" 1
# 39 "drivers/displays/tft/controls/labelcentered.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 40 "drivers/displays/tft/controls/labelcentered.h" 2
...
# 41 "drivers/displays/tft/controls/labelcentered.h" 2

void labelcenteredRender(uint16_t x, uint16_t y, uint16_t bgColor, uint16_t fontColor, char *text, theme_t theme);
# 41 "drivers/displays/tft/controls/labelcentered.c" 2
# 58 "drivers/displays/tft/controls/labelcentered.c"
void labelcenteredRender(uint16_t x, uint16_t y, uint16_t bgColor, uint16_t fontColor, char *text, theme_t theme)
{
# 69 "drivers/displays/tft/controls/labelcentered.c"
    if (text != ((void *)0))
    {
      uint16_t textWidth = fontsGetStringWidth(&dejaVuSans9ptFontInfo, text);
      uint16_t xStart = x - (textWidth / 2);
      fontsDrawString(xStart, y, fontColor, &dejaVuSans9ptFontInfo, text);
    }
