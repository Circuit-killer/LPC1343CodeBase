# 1 "drivers/displays/tft/controls/button.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/displays/tft/controls/button.c"
# 38 "drivers/displays/tft/controls/button.c"
...
# 39 "drivers/displays/tft/controls/button.c" 2

# 1 "drivers/displays/tft/controls/button.h" 1
# 39 "drivers/displays/tft/controls/button.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 40 "drivers/displays/tft/controls/button.h" 2
...
# 41 "drivers/displays/tft/controls/button.h" 2

void buttonRender(uint16_t x, uint16_t y, uint16_t width, uint16_t height, uint16_t fontColor, char *text, theme_t theme);
# 41 "drivers/displays/tft/controls/button.c" 2
# 60 "drivers/displays/tft/controls/button.c"
void buttonRender(uint16_t x, uint16_t y, uint16_t width, uint16_t height, uint16_t fontColor, char *text, theme_t theme)
{
...
# 80 "drivers/displays/tft/controls/button.c"
    if (text != ((void *)0))
    {
      uint16_t textWidth = fontsGetStringWidth(&dejaVuSans9ptFontInfo, text);
      uint16_t xStart = x + (width / 2) - (textWidth / 2);
      uint16_t yStart = y + (height / 2) - (dejaVuSans9ptFontInfo.height / 2) + 1;
      fontsDrawString(xStart, yStart, fontColor, &dejaVuSans9ptFontInfo, text);
    }
