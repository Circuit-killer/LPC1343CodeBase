# 1 "project/commands/cmd_uart.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "project/commands/cmd_uart.c"
# 39 "project/commands/cmd_uart.c"
...
# 40 "project/commands/cmd_uart.c" 2
...
# 42 "project/commands/cmd_uart.c" 2
# 1 "./core/cmd/cmd.h" 1
# 44 "./core/cmd/cmd.h"
typedef struct
{
...
# 47 "project/commands/cmd_uart.c" 2
...
# 48 "project/commands/cmd_uart.c" 2
...
void cmd_uart(uint8_t argc, char **argv)
{
  if (argc > 0)
  {
    ...
    {
      printf("Invalid baud rate: 9600-115200 required.%s", "\r\n");
      return;
    }


    printf("Setting UART to: %d%s", (int)speed, "\r\n");
    eepromWriteU32((uint16_t)(0x0020), speed);
  ...
  else
  {
      ...
      uint32_t uartEEPROM = eepromReadU32((uint16_t)(0x0020));
      if ((uartEEPROM < 9600) || (uartEEPROM > 115200))
      {
        printf("UART not set in EEPROM%s", "\r\n");
      }
      else
      {
        printf("%u%s", (unsigned int)uartEEPROM, "\r\n");
      }
