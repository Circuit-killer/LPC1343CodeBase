# 1 "core/timer16/timer16.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "core/timer16/timer16.c"
# 74 "core/timer16/timer16.c"
# 1 "core/timer16/timer16.h" 1
# 42 "core/timer16/timer16.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
void timer16DelayTicks(uint8_t timerNum, uint16_t delayInTicks)
{
  ...
  if (timerNum == 0)
  {
    ...
    (*((REG32 *) (0x4000C004))) = ((unsigned int) 0x00000002);


    (*((REG32 *) (0x4000C00C))) = 0x00;

    (*((REG32 *) (0x4000C018))) = delayInTicks;


    (*((REG32 *) (0x4000C000))) = ((unsigned int) 0x0000001F);


    (*((REG32 *) (0x4000C014))) = ((unsigned int) 0x00000004);


    (*((REG32 *) (0x4000C004))) = ((unsigned int) 0x00000001);


    while ((*((REG32 *) (0x4000C004))) & ((unsigned int) 0x00000001));
  }

  else if (timerNum == 1)
  {

    (*((REG32 *) (0x40010004))) = ((unsigned int) 0x00000002);


    (*((REG32 *) (0x4001000C))) = 0x00;

    (*((REG32 *) (0x40010018))) = delayInTicks;


    (*((REG32 *) (0x40010000))) = ((unsigned int) 0x0000001F);


    (*((REG32 *) (0x40010014))) = ((unsigned int) 0x00000004);


    (*((REG32 *) (0x40010004))) = ((unsigned int) 0x00000001);


    while ((*((REG32 *) (0x40010004))) & ((unsigned int) 0x00000001));
  }

  return;
}
# 219 "core/timer16/timer16.c"
void timer16DelayUS(uint8_t timerNum, uint16_t delayInUS)
{
  ...
  if (timerNum == 0)
  {
    ...
    (*((REG32 *) (0x4000C018))) = delayInUS * (((72000000)/(*((REG32 *) (0x40048078))))/1000000);
  ...
  else if (timerNum == 1)
  {
    ...
    (*((REG32 *) (0x40010018))) = delayInUS * (((72000000)/(*((REG32 *) (0x40048078))))/1000000);
...
# 359 "core/timer16/timer16.c"
void timer16Disable(uint8_t timerNum)
{
  if ( timerNum == 0 )
  {
    (*((REG32 *) (0x4000C004))) = ((unsigned int) 0x00000000);
  }

  else if (timerNum == 1)
  {
    (*((REG32 *) (0x40010004))) = ((unsigned int) 0x00000000);
  }

  return;
}
# 382 "core/timer16/timer16.c"
void timer16Reset(uint8_t timerNum)
{
  uint32_t regVal;
  ...
  if ( timerNum == 0 )
  {
    regVal = (*((REG32 *) (0x4000C004)));
    regVal |= ((unsigned int) 0x00000002);
    (*((REG32 *) (0x4000C004))) = regVal;
  }

  else if (timerNum == 1)
  {
    regVal = (*((REG32 *) (0x40010004)));
    regVal |= ((unsigned int) 0x00000002);
    (*((REG32 *) (0x40010004))) = regVal;
  }

  return;
}
# 427 "core/timer16/timer16.c"
void timer16Init(uint8_t timerNum, uint16_t timerInterval)
{

  if (timerInterval < 1)
  {
    timerInterval = (0xFFFF);
  }
...
# 462 "core/timer16/timer16.c"
    timer16_0_counter = 0;
    (*((REG32 *) (0x4000C018))) = timerInterval;


    (*((REG32 *) (0x4000C014))) = (((unsigned int) 0x00000001) | ((unsigned int) 0x00000002));
...
# 495 "core/timer16/timer16.c"
    timer16_1_counter = 0;
    (*((REG32 *) (0x40010018))) = timerInterval;


    (*((REG32 *) (0x40010014))) = (((unsigned int) 0x00000001) | ((unsigned int) 0x00000002));
