...
# 44 "core/gpio/gpio.c" 2
# 54 "core/gpio/gpio.c"
static _Bool _gpioInitialised = 0;
# 86 "core/gpio/gpio.c"
void PIOINT1_IRQHandler(void)
{
  uint32_t regVal;
# 109 "core/gpio/gpio.c"
...
# 174 "core/gpio/gpio.c"
void gpioInit (void)
{

  (*((REG32 *) (0x40048080))) |= (((unsigned int) 0x00000040));
...
# 204 "core/gpio/gpio.c"
void gpioSetDir (uint32_t portNum, uint32_t bitPos, gpioDirection_t dir)
{
  if (!_gpioInitialised) gpioInit();


  REG32 *gpiodir = &(*((REG32 *) (0x50008000)));
  switch (portNum)
  {
    case 0:
      gpiodir = &(*((REG32 *) (0x50008000)));
      break;
    case 1:
      gpiodir = &(*((REG32 *) (0x50018000)));
      break;
    case 2:
      gpiodir = &(*((REG32 *) (0x50028000)));
      break;
    case 3:
      gpiodir = &(*((REG32 *) (0x50038000)));
      break;
  }
...
# 267 "core/gpio/gpio.c"
void gpioSetInterrupt (uint32_t portNum, uint32_t bitPos, gpioInterruptSense_t sense, gpioInterruptEdge_t edge, gpioInterruptEvent_t event)
{
  if (!_gpioInitialised) gpioInit();


  REG32 *gpiois = &(*((REG32 *) (0x50008004)));
  REG32 *gpioibe = &(*((REG32 *) (0x50008008)));
  REG32 *gpioiev = &(*((REG32 *) (0x5000800C)));
  switch (portNum)
  {
    case 0:
      gpiois = &(*((REG32 *) (0x50008004)));
      gpioibe = &(*((REG32 *) (0x50008008)));
      gpioiev = &(*((REG32 *) (0x5000800C)));
      break;
    case 1:
      gpiois = &(*((REG32 *) (0x50018004)));
      gpioibe = &(*((REG32 *) (0x50018008)));
      gpioiev = &(*((REG32 *) (0x5001800C)));
      break;
    case 2:
      gpiois = &(*((REG32 *) (0x50028004)));
      gpioibe = &(*((REG32 *) (0x50028008)));
      gpioiev = &(*((REG32 *) (0x5002800C)));
      break;
    case 3:
      gpiois = &(*((REG32 *) (0x50038004)));
      gpioibe = &(*((REG32 *) (0x50038008)));
      gpioiev = &(*((REG32 *) (0x5003800C)));
      break;
  }
...
void gpioIntEnable (uint32_t portNum, uint32_t bitPos)
{
  ...
  {
    case 0:
      (*((REG32 *) (0x50008010))) |= (0x1<<bitPos);
      break;
    case 1:
      (*((REG32 *) (0x50018010))) |= (0x1<<bitPos);
      break;
    case 2:
      (*((REG32 *) (0x50028010))) |= (0x1<<bitPos);
      break;
    case 3:
      (*((REG32 *) (0x50038010))) |= (0x1<<bitPos);
      break;
    default:
      break;
  }
...
uint32_t gpioIntStatus (uint32_t portNum, uint32_t bitPos)
{
  ...
  {
    case 0:
      if ((*((REG32 *) (0x50008018))) & (0x1<<bitPos))
      {
        regVal = 1;
      }
      break;
    case 1:
      if ((*((REG32 *) (0x50018018))) & (0x1<<bitPos))
      {
        regVal = 1;
      }
      break;
    case 2:
      if ((*((REG32 *) (0x50028018))) & (0x1<<bitPos))
      {
        regVal = 1;
      }
      break;
    case 3:
      if ((*((REG32 *) (0x50038018))) & (0x1<<bitPos))
      {
        regVal = 1;
      }
      break;
...
void gpioIntClear (uint32_t portNum, uint32_t bitPos)
{
  ...
  {
    case 0:
      (*((REG32 *) (0x5000801C))) |= (0x1<<bitPos);
    break;
    case 1:
      (*((REG32 *) (0x5001801C))) |= (0x1<<bitPos);
    break;
    case 2:
      (*((REG32 *) (0x5002801C))) |= (0x1<<bitPos);
    break;
    case 3:
      (*((REG32 *) (0x5003801C))) |= (0x1<<bitPos);
    break;
    default:
      break;
  }
...
void gpioSetPullup (volatile uint32_t *ioconReg, gpioPullupMode_t mode)
{
  ...
  *ioconReg &= ~(((unsigned int) 0x00000018));
  *ioconReg |= mode;
