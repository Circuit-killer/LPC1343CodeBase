# 1 "core/usbhid-rom/usbhid.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "core/usbhid-rom/usbhid.c"
# 36 "core/usbhid-rom/usbhid.c"
...
# 37 "core/usbhid-rom/usbhid.c" 2

# 1 "./core/usbhid-rom/usb.h" 1
# 22 "./core/usbhid-rom/usb.h"
# 1 "./sysdefs.h" 1
# 42 "./sysdefs.h"
...
# 39 "core/usbhid-rom/usbhid.c" 2
# 1 "./core/usbhid-rom/usbconfig.h" 1
# 42 "./core/usbhid-rom/usbconfig.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 43 "./core/usbhid-rom/usbconfig.h" 2
# 59 "./core/usbhid-rom/usbconfig.h"
...
# 40 "core/usbhid-rom/usbhid.c" 2
# 1 "./core/rom_drivers.h" 1
# 13 "./core/rom_drivers.h"
...
# 44 "core/usbhid-rom/usbhid.c" 2

# 1 "core/usbhid-rom/usbhid.h" 1
# 46 "core/usbhid-rom/usbhid.c" 2
...
void usbHIDGetInReport (uint8_t src[], uint32_t length)
{
  ...
  out.gpio1Dir = (*((REG32 *) (0x50018000)));
  out.gpio1Data = (*((REG32 *) (0x50013FFC)));
  out.gpio2Dir = (*((REG32 *) (0x50028000)));
  out.gpio2Data = (*((REG32 *) (0x50023FFC)));
  out.gpio3Dir = (*((REG32 *) (0x50038000)));
  out.gpio3Data = (*((REG32 *) (0x50033FFC)));
  out.adc0 = adcRead(0);
  out.adc1 = adcRead(1);
  out.adc2 = adcRead(2);
  out.adc3 = adcRead(3);
...
# 152 "core/usbhid-rom/usbhid.c"
void usbHIDInit (void)
{

  (*((REG32 *) (0x40048238))) &= ~(((unsigned int) 0x00000400));
  (*((REG32 *) (0x40048238))) &= ~(((unsigned int) 0x00000100));

  (*((REG32 *) (0x40048048))) = ((unsigned int) 0x00000001);
  (*((REG32 *) (0x4004804C))) = ((unsigned int) 0x00000001);
  (*((REG32 *) (0x4004804C))) = ((unsigned int) 0x00000000);
  (*((REG32 *) (0x4004804C))) = ((unsigned int) 0x00000001);


  while (!((*((REG32 *) (0x4004804C))) & ((unsigned int) 0x00000001)));


  (*((REG32 *) (0x40048010))) = (((unsigned int) 0x00000003));
  while (!((*((REG32 *) (0x40048014))) & ((unsigned int) 0x00000001)));
  (*((REG32 *) (0x400480C0))) = ((unsigned int) 0x00000000);


  (*((REG32 *) (0x40044010))) &= ~((unsigned int) 0x00000007);
  (*((REG32 *) (0x40044010))) |= ((unsigned int) 0x00000001);
  (*((REG32 *) (0x4004402C))) &= ~((unsigned int) 0x00000007);
  (*((REG32 *) (0x4004402C))) |= ((unsigned int) 0x00000001);
  (*((REG32 *) (0x4004404C))) &= ~((unsigned int) 0x00000007);
  (*((REG32 *) (0x4004404C))) |= ((unsigned int) 0x00000001);


  gpioSetPullup(&(*((REG32 *) (0x4004402C))), gpioPullupMode_Inactive);


  volatile int n;
  HidDevInfo.idVendor = (0x1d50);
  HidDevInfo.idProduct = (0x600c);
  ...
  (*((REG32 *) (0x40048080))) |= (((unsigned int) 0x00000400) | ((unsigned int) 0x00010000) | ((unsigned int) 0x00004000));
