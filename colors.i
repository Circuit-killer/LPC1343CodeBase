# 1 "drivers/displays/tft/colors.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/displays/tft/colors.c"
# 40 "drivers/displays/tft/colors.c"
...
# 41 "drivers/displays/tft/colors.c" 2

# 1 "drivers/displays/tft/colors.h" 1
# 41 "drivers/displays/tft/colors.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 42 "drivers/displays/tft/colors.h" 2
...
# 43 "drivers/displays/tft/colors.c" 2
# 77 "drivers/displays/tft/colors.c"
uint16_t colorsRGB24toRGB565(uint8_t r, uint8_t g, uint8_t b)
{
  return ((r / 8) << 11) | ((g / 4) << 5) | (b / 8);
}
# 111 "drivers/displays/tft/colors.c"
uint32_t colorsRGB565toBGRA32(uint16_t color)
{
...
# 182 "drivers/displays/tft/colors.c"
uint16_t colorsDim(uint16_t color, uint8_t intensity)
{
  uint16_t r, g, b;
...
# 239 "drivers/displays/tft/colors.c"
uint16_t colorsAlphaBlend(uint16_t bgColor, uint16_t foreColor, uint8_t fadePercent)
{
  uint16_t br, bg, bb;
  uint16_t fr, fg, fb;
  uint16_t newr, newg, newb;
  ...
  newg = (fadePercent * bg + (100 - fadePercent) * fg) / 200;
