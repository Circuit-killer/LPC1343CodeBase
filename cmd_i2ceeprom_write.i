# 1 "project/commands/cmd_i2ceeprom_write.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "project/commands/cmd_i2ceeprom_write.c"
# 39 "project/commands/cmd_i2ceeprom_write.c"
...
# 40 "project/commands/cmd_i2ceeprom_write.c" 2
...
# 42 "project/commands/cmd_i2ceeprom_write.c" 2
# 1 "./core/cmd/cmd.h" 1
# 44 "./core/cmd/cmd.h"
typedef struct
{
...
void cmdInit();
# 43 "project/commands/cmd_i2ceeprom_write.c" 2
# 1 "./project/commands.h" 1
# 42 "./project/commands.h"
int getNumber (char *s, int32_t *result);
# 44 "project/commands/cmd_i2ceeprom_write.c" 2
...
# 47 "project/commands/cmd_i2ceeprom_write.c" 2
...
void cmd_i2ceeprom_write(uint8_t argc, char **argv)
{
  ...
  if (addr <= (0x00FF))
  {
    printf("ERROR: Reserved address (0x%04X-0x%04X)%s", 0, (0x00FF), "\r\n");
    return;
  }
  ...
  {
    printf("Invalid Data: 0-255 or 0x00-0xFF required.%s", "\r\n");
    return;
  }
  ...
  printf("0x%02X written at 0x%04X%s", val, addr, "\r\n");
}
