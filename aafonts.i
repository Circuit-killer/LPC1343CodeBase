# 1 "drivers/displays/tft/aafonts.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "drivers/displays/tft/aafonts.c"
# 36 "drivers/displays/tft/aafonts.c"
...
# 37 "drivers/displays/tft/aafonts.c" 2
...
# 39 "drivers/displays/tft/aafonts.c" 2
...
# 40 "drivers/displays/tft/aafonts.c" 2
...
# 77 "drivers/displays/tft/aafonts.c"
...
# 132 "drivers/displays/tft/aafonts.c"
...
# 195 "drivers/displays/tft/aafonts.c"
void aafontsDrawString(uint16_t x, uint16_t y, const uint16_t * colorTable, const aafontsFont_t *font, char *str)
{
...
# 259 "drivers/displays/tft/aafonts.c"
void aafontsCenterString(uint16_t x, uint16_t y, const uint16_t * colorTable, const aafontsFont_t *font, char *str)
{
...
# 291 "drivers/displays/tft/aafonts.c"
uint16_t aafontsGetStringWidth(const aafontsFont_t *font, char *str)
{
  uint16_t width = 0;
  const aafontsCharInfo_t *charInfo;
...
# 365 "drivers/displays/tft/aafonts.c"
void aafontsCalculateColorTable(uint16_t bgColor, uint16_t foreColor, uint16_t *colorTable, size_t tableSize)
{
  uint16_t i, stepsize;
