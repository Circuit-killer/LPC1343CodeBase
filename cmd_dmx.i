...
# 2 "project/commands/cmd_dmx.c" 2
...
# 4 "project/commands/cmd_dmx.c" 2
# 1 "./core/cmd/cmd.h" 1
# 44 "./core/cmd/cmd.h"
typedef struct
{
...
# 8 "project/commands/cmd_dmx.c" 2
...
void cmd_dmx(uint8_t argc, char **argv) {
  ...
  {
    printf("Invalid channel, must be [0..%d]%s", 8, "\r\n");
    return;
  }
  ...
  {
    printf("Invalid value, must be [0..255]%s", "\r\n");
    return;
  }

  printf("Setting dmx channel %d to %d%s", channel, value, "\r\n");
