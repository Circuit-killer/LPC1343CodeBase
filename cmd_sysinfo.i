# 1 "project/commands/cmd_sysinfo.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "project/commands/cmd_sysinfo.c"
# 39 "project/commands/cmd_sysinfo.c"
...
# 40 "project/commands/cmd_sysinfo.c" 2
...
# 42 "project/commands/cmd_sysinfo.c" 2
# 1 "./core/cmd/cmd.h" 1
# 44 "./core/cmd/cmd.h"
typedef struct
{
...
void cmdInit();
# 43 "project/commands/cmd_sysinfo.c" 2
...
# 44 "project/commands/cmd_sysinfo.c" 2
# 1 "./core/iap/iap.h" 1
# 52 "./core/iap/iap.h"
typedef struct
{
...
# 45 "project/commands/cmd_sysinfo.c" 2
# 1 "./project/commands.h" 1
# 42 "./project/commands.h"
int getNumber (char *s, int32_t *result);
# 46 "project/commands/cmd_sysinfo.c" 2
# 74 "project/commands/cmd_sysinfo.c"
void cmd_sysinfo(uint8_t argc, char **argv)
{
  ...
  printf("%-25s : %d.%d.%d %s", "Firmware", (1), (1), (0), "\r\n");
  printf("%-25s : %d.%d MHz %s", "System Clock", (72000000) / 1000000, (72000000) % 1000000, "\r\n");


  printf("%-25s : %u s %s", "System Uptime", (unsigned int)systickGetSecondsActive(), "\r\n");


  iap_return = iapReadSerialNumber();
  if(iap_return.ReturnCode == 0)
  {
    printf("%-25s : %08X %08X %08X %08X %s", "Serial Number", iap_return.Result[0],iap_return.Result[1],iap_return.Result[2],iap_return.Result[3], "\r\n");
  }
# 176 "project/commands/cmd_sysinfo.c"
}
