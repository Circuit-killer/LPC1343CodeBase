# 1 "core/timer32/timer32.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "core/timer32/timer32.c"
# 68 "core/timer32/timer32.c"
# 1 "core/timer32/timer32.h" 1
# 42 "core/timer32/timer32.h"
# 1 "./projectconfig.h" 1
# 40 "./projectconfig.h"
# 1 "./lpc134x.h" 1
# 46 "./lpc134x.h"
...
# 69 "core/timer32/timer32.c" 2

volatile uint32_t timer32_0_counter = 0;
volatile uint32_t timer32_1_counter = 0;
void (*interruptHandler0)(void) = ((void *)0);
# 86 "core/timer32/timer32.c"
void timer32Delay(uint8_t timerNum, uint32_t delay)
{
  uint32_t curTicks;
...
void TIMER32_0_IRQHandler(void)
{
    ...
    if(((void *)0) != interruptHandler0)
    {
        (*interruptHandler0)();
    }


    (*((REG32 *) (0x40014000))) = ((unsigned int) 0x00000001);
...
void TIMER32_1_IRQHandler(void)
{
  ...
  (*((REG32 *) (0x40018000))) = ((unsigned int) 0x00000001);
...
void timer32Enable(uint8_t timerNum)
{
  ...
  {
    (*((REG32 *) (0x40018004))) = ((unsigned int) 0x00000001);
  }

  return;
}
# 198 "core/timer32/timer32.c"
void timer32Disable(uint8_t timerNum)
{
  if ( timerNum == 0 )
  {
  ...
  {
    (*((REG32 *) (0x40018004))) = ((unsigned int) 0x00000000);
  }

  return;
}
# 221 "core/timer32/timer32.c"
void timer32Reset(uint8_t timerNum)
{
  uint32_t regVal;
  ...
  if ( timerNum == 0 )
  {
    regVal = (*((REG32 *) (0x40014004)));
    regVal |= ((unsigned int) 0x00000002);
    (*((REG32 *) (0x40014004))) = regVal;
  }

  else if (timerNum == 1)
  {
    regVal = (*((REG32 *) (0x40018004)));
    regVal |= ((unsigned int) 0x00000002);
    (*((REG32 *) (0x40018004))) = regVal;
  }

  return;
}
# 258 "core/timer32/timer32.c"
void timer32Init(uint8_t timerNum, uint32_t timerInterval)
{

  if (timerInterval < 1)
  {
    timerInterval = ((((72000000)/(*((REG32 *) (0x40048078)))) / 10000));
  }
...
# 297 "core/timer32/timer32.c"
    timer32_0_counter = 0;
    (*((REG32 *) (0x40014018))) = timerInterval;
  ...
  else if ( timerNum == 1 )
  {
    ...
    (*((REG32 *) (0x40048080))) |= (((unsigned int) 0x00000400));
# 339 "core/timer32/timer32.c"
    timer32_1_counter = 0;
    (*((REG32 *) (0x40018018))) = timerInterval;


    (*((REG32 *) (0x40018014))) = (((unsigned int) 0x00000001) | ((unsigned int) 0x00000002));
