# 1 "project/commands.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "project/commands.c"
# 40 "project/commands.c"
...
# 42 "project/commands.c" 2
# 1 "/Users/mm/arm-cs-tools/lib/gcc/arm-none-eabi/4.6.3/../../../../arm-none-eabi/include/ctype.h" 1 3
...
# 48 "/Users/mm/arm-cs-tools/lib/gcc/arm-none-eabi/4.6.3/../../../../arm-none-eabi/include/ctype.h" 3
int isalnum (int __c);
int isalpha (int __c);
int iscntrl (int __c);
int isdigit (int __c);
...
int isascii (int __c);
int toascii (int __c);
# 83 "/Users/mm/arm-cs-tools/lib/gcc/arm-none-eabi/4.6.3/../../../../arm-none-eabi/include/ctype.h" 3
const

extern char *__ctype_ptr__;
# 151 "/Users/mm/arm-cs-tools/lib/gcc/arm-none-eabi/4.6.3/../../../../arm-none-eabi/include/ctype.h" 3
extern const char _ctype_[];


# 43 "project/commands.c" 2
...
void cmdInit();
# 45 "project/commands.c" 2
# 1 "project/commands.h" 1
# 42 "project/commands.h"
int getNumber (char *s, int32_t *result);
# 46 "project/commands.c" 2
# 72 "project/commands.c"
int getNumber (char *s, int32_t *result)
{
  int32_t value;
  uint32_t mustBeHex = 0;
  uint32_t sgn = 1;
  ...
  for (value = 0; *s; s++)
  {
    if (mustBeHex && (((__ctype_ptr__+sizeof(""[(uint8_t)*s]))[(int)((uint8_t)*s)])&(0100|04)))
      value = (value << 4) | hexToDec [__extension__ ({ __typeof__ ((uint8_t)*s) __x = ((uint8_t)*s); ((((__ctype_ptr__+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;}) - '0'];
    else if ((((__ctype_ptr__+sizeof(""[(uint8_t)*s]))[(int)((uint8_t)*s)])&04))
